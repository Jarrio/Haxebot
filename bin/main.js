// Generated by Haxe 5.0.0-alpha.1+7142d83
...
Main.start = function() {
	...
	Main.client.on("guildMemberAdd",function(member) {
		haxe_Log.trace("member " + member.user.tag,{ fileName : "src/Main.hx", lineNumber : 180, className : "Main", methodName : "start"});
	...
	Main.client.on("ChatInputAutoCompleteEvent",function(incoming) {
		haxe_Log.trace("disconnected",{ fileName : "src/Main.hx", lineNumber : 249, className : "Main", methodName : "start"});
		haxe_Log.trace(incoming,{ fileName : "src/Main.hx", lineNumber : 250, className : "Main", methodName : "start"});
	});
	...
	Main.client.on("interactionCreate",function(interaction) {
		...
		if(interaction.isModalSubmit()) {
			haxe_Log.trace("here",{ fileName : "src/Main.hx", lineNumber : 282, className : "Main", methodName : "start"});
			haxe_Log.trace(interaction.customId,{ fileName : "src/Main.hx", lineNumber : 283, className : "Main", methodName : "start"});
			switch(interaction.customId) {
			case "code_paste":
				haxe_Log.trace("here",{ fileName : "src/Main.hx", lineNumber : 292, className : "Main", methodName : "start"});
				var _ecsTmpEntity = Main.universe.createEntity();
...
Main.saveCommand = function(command) {
	...
	haxe_Log.trace("registered " + command.name,{ fileName : "src/Main.hx", lineNumber : 454, className : "Main", methodName : "saveCommand"});
};
Main.main = function() {
	try {
		...
		haxe_Log.trace(e.get_message(),{ fileName : "src/Main.hx", lineNumber : 470, className : "Main", methodName : "main"});
	}
	...
	firebase_web_auth_Auth.signInWithEmailAndPassword(firebase_web_auth_Auth.getAuth(),Main.keys.username,Main.keys.password).then(function(res) {
		haxe_Log.trace("logged in",{ fileName : "src/Main.hx", lineNumber : 480, className : "Main", methodName : "main"});
		...
		firebase_web_firestore_Firestore.onSnapshot(doc,function(resp) {
			...
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 490, className : "Main", methodName : "main"});
			$global.console.dir(err);
		});
	});
	Main.start();
...
Main.updateState = function(field,value) {
	...
	firebase_web_firestore_Firestore.updateDoc(doc,field,value).then(null,function(err) {
		haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 502, className : "Main", methodName : "updateState"});
		$global.console.dir(err);
	});
};
...
commands_Notify.prototype = $extend(systems_CommandBase.prototype,{
	...
	,run: function(command,interaction) {
		...
		if(_g._hx_index == 26) {
			...
			if(role == "err") {
				haxe_Log.trace(channel,{ fileName : "src/commands/Notify.hx", lineNumber : 39, className : "commands.Notify", methodName : "run"});
				haxe_Log.trace(interaction.command,{ fileName : "src/commands/Notify.hx", lineNumber : 40, className : "commands.Notify", methodName : "run"});
			...
			interaction.member.fetch(true).then(function(member) {
				...
				if(found) {
					interaction.member.roles.remove(role).then(function(success) {
						...
						haxe_Log.trace(err,{ fileName : "src/commands/Notify.hx", lineNumber : 58, className : "commands.Notify", methodName : "run"});
						$global.console.dir(err);
					});
				} else {
					interaction.member.roles.add(role).then(function(success) {
						...
						haxe_Log.trace(err,{ fileName : "src/commands/Notify.hx", lineNumber : 71, className : "commands.Notify", methodName : "run"});
						$global.console.dir(err);
					});
				}
			},function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/Notify.hx", lineNumber : 76, className : "commands.Notify", methodName : "run"});
				$global.console.dir(err);
			});
		}
	}
...
commands_Trace.prototype = $extend(systems_CommandBase.prototype,{
	...
	,runCode: function(code,interaction) {
		...
		js_node_Fs.appendFile("" + this.get_base_path() + "/hx/" + filename + ".hx",final_code + ("\n//User:" + interaction.user.tag + " id: " + interaction.user.id + "| time: " + Std.string(new Date())),function(error) {
			...
			ls.stderr.once("data",function(data) {
				haxe_Log.trace("error: " + (data == null ? "null" : "" + data),{ fileName : "src/commands/Trace.hx", lineNumber : 148, className : "commands.Trace", methodName : "runCode"});
					...
					if(this.findKeywords(message,tracker)) {
						if(Object.prototype.hasOwnProperty.call(this.dm.h,tracker.by)) {
							...
							this.dm.h[tracker.by].send({ embeds : [embed]}).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 114, className : "commands.mod.Tracker", methodName : "update"});
							});
							break;
						}
					}
	...
	,run: function(command,interaction) {
		...
		case 5:
			...
			while(_g_current < _g_array.length) {
				...
				string = StringTools.replace(string,"@","");
				string = StringTools.replace(string,"&","");
				haxe_Log.trace(string,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 257, className : "commands.mod.Tracker", methodName : "cleanDiscordThings"});
			...
			if(name != null) {
				...
				if(interaction.isAutocomplete()) {
					firebase_web_firestore_Firestore.getDocs(query).then(function(res) {
						...
						interaction.respond(results).then(null,function(err) {
							haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 189, className : "commands.mod.Tracker", methodName : "run"});
							$global.console.dir(err);
						});
					}).then(null,function(err) {
				...
				firebase_web_firestore_Firestore.deleteDoc(firebase_web_firestore_Firestore.doc(firebase_web_firestore_Firestore.getFirestore(firebase_web_app_FirebaseApp.getApp()),"discord/admin/trackers/" + name)).then(function(_) {
					...
					interaction.reply({ content : "Tracker deleted!", ephemeral : true}).then(null,function(err) {
						haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 207, className : "commands.mod.Tracker", methodName : "run"});
					});
				},function(err) {
					haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 209, className : "commands.mod.Tracker", methodName : "run"});
					$global.console.dir(err);
				});
				haxe_Log.trace(name,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 212, className : "commands.mod.Tracker", methodName : "run"});
			}
			break;
		default:
		}
	...
	,parseTracker: function(interaction,name,description,keywords,string_exclude,channel_exclude,user_exclude) {
		...
		firebase_web_firestore_Firestore.addDoc(firebase_web_firestore_Firestore.collection(firebase_web_firestore_Firestore.getFirestore(firebase_web_app_FirebaseApp.getApp()),"discord/admin/trackers"),obj).then(function(_) {
			interaction.reply({ content : "Your tracker is now active!", ephemeral : true}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 247, className : "commands.mod.Tracker", methodName : "parseTracker"});
			});
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 248, className : "commands.mod.Tracker", methodName : "parseTracker"});
		});
	}
...
var components_CommandOptions = $hxEnums["components.CommandOptions"] = { __ename__:"components.CommandOptions",__constructs__:null
	...
	,SnippetList: ($_=function(user,show_desc) { return {_hx_index:3,user:user,show_desc:show_desc,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.user,this.show_desc];}}; },$_._hx_name="SnippetList",$_)
	,Color: ($_=function(role) { return {_hx_index:4,role:role,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.role];}}; },$_._hx_name="Color",$_)
	,TrackerCreate: ($_=function(name,keywords,description,string_exclude,channel_exclude,user_exclude) { return {_hx_index:5,name:name,keywords:keywords,description:description,string_exclude:string_exclude,channel_exclude:channel_exclude,user_exclude:user_exclude,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.name,this.keywords,this.description,this.string_exclude,this.channel_exclude,this.user_exclude];}}; },$_._hx_name="TrackerCreate",$_)
	,TrackerDelete: ($_=function(name) { return {_hx_index:6,name:name,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.name];}}; },$_._hx_name="TrackerDelete",$_)
	,SnippetEdit: ($_=function(id) { return {_hx_index:7,id:id,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.id];}}; },$_._hx_name="SnippetEdit",$_)
	,SnippetDelete: ($_=function(id) { return {_hx_index:8,id:id,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.id];}}; },$_._hx_name="SnippetDelete",$_)
	,SnippetSearch: ($_=function(taga,tagb,tagc) { return {_hx_index:9,taga:taga,tagb:tagb,tagc:tagc,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.taga,this.tagb,this.tagc];}}; },$_._hx_name="SnippetSearch",$_)
	,SnippetAdd: ($_=function(url,title,description,taga,tagb,tagc,tagd,tage) { return {_hx_index:10,url:url,title:title,description:description,taga:taga,tagb:tagb,tagc:tagc,tagd:tagd,tage:tage,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.url,this.title,this.description,this.taga,this.tagb,this.tagc,this.tagd,this.tage];}}; },$_._hx_name="SnippetAdd",$_)
	,Reminder: ($_=function(content,when,personal,thread_reply) { return {_hx_index:11,content:content,when:when,personal:personal,thread_reply:thread_reply,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.content,this.when,this.personal,this.thread_reply];}}; },$_._hx_name="Reminder",$_)
	,Social: ($_=function(tag,user) { return {_hx_index:12,tag:tag,user:user,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.tag,this.user];}}; },$_._hx_name="Social",$_)
	,Ban: ($_=function(user,reason,delete_messages) { return {_hx_index:13,user:user,reason:reason,delete_messages:delete_messages,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.user,this.reason,this.delete_messages];}}; },$_._hx_name="Ban",$_)
	,Say: ($_=function(message,message_id) { return {_hx_index:14,message:message,message_id:message_id,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.message,this.message_id];}}; },$_._hx_name="Say",$_)
	,React: ($_=function(message_id,emoji) { return {_hx_index:15,message_id:message_id,emoji:emoji,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.message_id,this.emoji];}}; },$_._hx_name="React",$_)
	,Helppls: ($_=function(topic) { return {_hx_index:16,topic:topic,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.topic];}}; },$_._hx_name="Helppls",$_)
	,Run: ($_=function(code) { return {_hx_index:17,code:code,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.code];}}; },$_._hx_name="Run",$_)
	,Trace: ($_=function(code) { return {_hx_index:18,code:code,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.code];}}; },$_._hx_name="Trace",$_)
	,Boop: ($_=function(user) { return {_hx_index:19,user:user,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.user];}}; },$_._hx_name="Boop",$_)
	,Poll: ($_=function(question,length,a,b,c,d,e,f,g,votes) { return {_hx_index:20,question:question,length:length,a:a,b:b,c:c,d:d,e:e,f:f,g:g,votes:votes,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.question,this.length,this.a,this.b,this.c,this.d,this.e,this.f,this.g,this.votes];}}; },$_._hx_name="Poll",$_)
	,Roundup: ($_=function(number) { return {_hx_index:21,number:number,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.number];}}; },$_._hx_name="Roundup",$_)
	,Rtfm: ($_=function(channel) { return {_hx_index:22,channel:channel,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.channel];}}; },$_._hx_name="Rtfm",$_)
	,Translate: ($_=function(to,message,from) { return {_hx_index:23,to:to,message:message,from:from,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.to,this.message,this.from];}}; },$_._hx_name="Translate",$_)
	,Helpdescription: ($_=function(description) { return {_hx_index:24,description:description,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.description];}}; },$_._hx_name="Helpdescription",$_)
	,Api: ($_=function(content,field) { return {_hx_index:25,content:content,field:field,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.content,this.field];}}; },$_._hx_name="Api",$_)
	,Notify: ($_=function(channel) { return {_hx_index:26,channel:channel,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.channel];}}; },$_._hx_name="Notify",$_)
	,Help: ($_=function(category) { return {_hx_index:27,category:category,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.category];}}; },$_._hx_name="Help",$_)
	,Haxelib: ($_=function(command) { return {_hx_index:28,command:command,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.command];}}; },$_._hx_name="Haxelib",$_)
	,QuoteList: ($_=function(user) { return {_hx_index:29,user:user,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.user];}}; },$_._hx_name="QuoteList",$_)
	,QuoteGet: ($_=function(name) { return {_hx_index:30,name:name,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.name];}}; },$_._hx_name="QuoteGet",$_)
	,QuoteDelete: ($_=function(name) { return {_hx_index:31,name:name,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.name];}}; },$_._hx_name="QuoteDelete",$_)
	,QuoteEdit: ($_=function(name) { return {_hx_index:32,name:name,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.name];}}; },$_._hx_name="QuoteEdit",$_)
	,QuoteCreate: ($_=function(name) { return {_hx_index:33,name:name,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.name];}}; },$_._hx_name="QuoteCreate",$_)
	,Mention: ($_=function(user,role) { return {_hx_index:34,user:user,role:role,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.user,this.role];}}; },$_._hx_name="Mention",$_)
