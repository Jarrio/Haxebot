...
var firebase_app_$types_FirebaseApp = require("@firebase/app-types").FirebaseApp;
...
var systems_commands_Helppls = function(universe) {
	...
	var firebase_config = { apiKey : "AIzaSyBKGASqr3dgNygiv3WnHzQKYv_iYTwK4Kk", authDomain : "haxe-forum.firebaseapp.com", databaseURL : "https://console.firebase.google.com/u/0/project/haxe-forum/firestore/data/~2F", projectId : "haxe-forum", storageBucket : "haxe-forum.appspot.com", messagingSenderId : "72566195073", appId : "1:72566195073:web:8d39d1f8d29227d2a79e80", measurementId : "G-VB7FNBVMZF"};
	firebase.app_types.FirebaseNamespace.initializeApp(firebase_config);
};
...
systems_commands_Helppls.prototype = $extend(systems_CommandBase.prototype,{
	...
	,update: function(_) {
		...
		while(_g.active && _g.idx < _g.set.size()) {
			...
			if(state == null) {
				haxe_Log.trace("something else " + state,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 130, className : "systems.commands.Helppls", methodName : "update"});
			} else {
				switch(state) {
				case 0:
				...
				case 4:
					...
					break;
				case 5:
					haxe_Log.trace("finished?",{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 81, className : "systems.commands.Helppls", methodName : "update"});
					...
					message[0].client.channels.fetch(this.getChannelId("other")).then((function(embed,message) {
						...
						return function(err) {
							haxe_Log.trace(err,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 120, className : "systems.commands.Helppls", methodName : "update"});
						};
					})());
					break;
				case 6:
