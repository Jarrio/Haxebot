		...
		while(_active && _g_idx >= 0) {
			...
			if(forward == "roundup_member_update") {
				if(this.event != null && this.event.status == 2) {
					...
					haxe_Log.trace(member,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 223, className : "commands.RoundupRoundup", methodName : "handleVoiceEvents"});
					if(member.id == this.get_host() && updated.channel == null) {
						member.send("Hi <@" + this.get_host() + ">, it looks like you left the voice channel. Should I end the event?").then(function(message) {
							...
							haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 232, className : "commands.RoundupRoundup", methodName : "handleVoiceEvents"});
						});
					}
				}
				this.universe.deleteEntity(entity);
	...
	,endEventCollector: function(reaction,user) {
		...
		if(reaction.emoji.name == "✅") {
			this.event.setStatus(3,"Host ended the event.").then(function(event) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 253, className : "commands.RoundupRoundup", methodName : "endEventCollector"});
			});
		}
	...
	,handleScheduledEvent: function() {
			...
			if(now - this.last_checked > commands_types_Duration.fromString("1m")) {
				...
				while(!_g_lastStep.done) {
					...
					if(v.id == this.get_host()) {
						...
						haxe_Log.trace("Host is active",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 276, className : "commands.RoundupRoundup", methodName : "handleScheduledEvent"});
						break;
					}
				}
			} else {
		...
		if(left <= commands_types_Duration.fromString("0s") && !this.waiting && this.host_active) {
			...
			this.event.setStatus(2,"Time to start the event!").then(function(_) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 290, className : "commands.RoundupRoundup", methodName : "handleScheduledEvent"});
				_gthis.waiting = true;
			});
		}
	}
	,createEvent: function(date) {
		...
		this.get_guild().scheduledEvents.create({ name : "Haxe Roundup Roundup", channel : this.voice_channel_id, entityType : 2, privacyLevel : 2, scheduledStartTime : date, description : "A community hosted discussion event where we go over the latest things that has gone on in the haxe over the last few weeks. We also have a period where people can show off what they're working on - its open floor come and join if you want :D"}).then(function(event) {
			...
			event.createInviteURL({ maxAge : 604800, channel : _gthis.voice_text_id}).then(function(url) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 321, className : "commands.RoundupRoundup", methodName : "createEvent"});
			});
			_gthis.setState(_gthis.get_state());
			haxe_Log.trace("Event setup!",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 323, className : "commands.RoundupRoundup", methodName : "createEvent"});
			...
			haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 328, className : "commands.RoundupRoundup", methodName : "createEvent"});
		});
	}
	,getEvent: function() {
		var _gthis = this;
		...
		this.get_schedule().fetch(this.get_state().event_id).then(function(event) {
			_gthis.waiting = false;
			haxe_Log.trace("Roundup event retrieved",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 339, className : "commands.RoundupRoundup", methodName : "getEvent"});
			_gthis.event = event;
			_gthis.handleEventStatus(event);
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 343, className : "commands.RoundupRoundup", methodName : "getEvent"});
			_gthis.waiting = false;
		});
	}
	,handleEndEvent: function() {
		...
		while(_active && _g_idx >= 0) {
			...
			this.event.setStatus(3,"Host ended the event.").then((function(data) {
				...
				return function(err) {
					haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 355, className : "commands.RoundupRoundup", methodName : "handleEndEvent"});
				};
			})());
			this.universe.deleteEntity(entity);
		}
	...
	,addCollection: function(time,emojis,message,on_collect,on_end) {
		...
		while(_g < emojis.length) {
			...
			message.react(e).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 364, className : "commands.RoundupRoundup", methodName : "addCollection"});
			});
		}
...
commands_Run2.prototype = $extend(systems_TextCommandBase.prototype,{
	...
	,onEnabled: function() {
		...
		http.onError = function(error) {
			haxe_Log.trace(error,{ fileName : "src/commands/Run2.hx", lineNumber : 53, className : "commands.Run2", methodName : "onEnabled"});
		};
		http.setPostData("{\r\n\t\t\t\t\"action\": \"haxe_version\"\r\n\t\t\t}");
		http.onData = function(response) {
			...
			if(parse.status == "Ok") {
				...
				haxe_Log.trace(parse.output,{ fileName : "src/commands/Run2.hx", lineNumber : 66, className : "commands.Run2", methodName : "onEnabled"});
				haxe_Log.trace(parse.error,{ fileName : "src/commands/Run2.hx", lineNumber : 67, className : "commands.Run2", methodName : "onEnabled"});
			}
		};
		http.request(true);
	}
	...
	,extractCode: function(message,response) {
		...
		if(check_code.match(message)) {
			...
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 100, className : "commands.Run2", methodName : "extractCode"});
			get_code.request();
			return;
		}
		...
		if(check_code.match(message)) {
			...
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 108, className : "commands.Run2", methodName : "extractCode"});
			return;
		}
		check_code = new EReg("!run[\\s|\n| \n](.*)","gmis");
		if(check_code.match(message)) {
			this.parse(check_code.matched(1),response);
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 115, className : "commands.Run2", methodName : "extractCode"});
			return;
		}
		haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 118, className : "commands.Run2", methodName : "extractCode"});
	...
	,parse: function(code,response) {
		if(code == null || code.length == 0) {
			...
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 191, className : "commands.Run2", methodName : "parse"});
			return;
		}
		...
		haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 205, className : "commands.Run2", methodName : "parse"});
	...
	,runCodeOnThread: function(code,message) {
		...
		haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 265, className : "commands.Run2", methodName : "runCodeOnThread"});
		try {
			var check_class = new EReg("(^class\\s(Test|Main)(\n|\\s|\\S))","mg");
			...
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 280, className : "commands.Run2", methodName : "runCodeOnThread"});
			code_content = format + "\n" + code_content;
			var http = new haxe_http_HttpNodeJs("http://" + this.site + ":1337");
			http.onError = function(error) {
				haxe_Log.trace(error,{ fileName : "src/commands/Run2.hx", lineNumber : 287, className : "commands.Run2", methodName : "runCodeOnThread"});
			};
			http.onData = function(response) {
				var parse = JSON.parse(response);
				haxe_Log.trace(response,{ fileName : "src/commands/Run2.hx", lineNumber : 292, className : "commands.Run2", methodName : "runCodeOnThread"});
				switch(parse.status) {
				case "OhNo":
					haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 373, className : "commands.Run2", methodName : "runCodeOnThread"});
					...
					haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 382, className : "commands.Run2", methodName : "runCodeOnThread"});
					if(embed == null) {
						haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 384, className : "commands.Run2", methodName : "runCodeOnThread"});
						message.reply({ allowedMentions : { parse : []}, content : mention + ("```\n" + compile_output + "```")});
					} else {
						haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 390, className : "commands.Run2", methodName : "runCodeOnThread"});
				...
				case "Ok":
					...
					haxe_Log.trace(resp,{ fileName : "src/commands/Run2.hx", lineNumber : 353, className : "commands.Run2", methodName : "runCodeOnThread"});
					haxe_Log.trace(parse,{ fileName : "src/commands/Run2.hx", lineNumber : 354, className : "commands.Run2", methodName : "runCodeOnThread"});
					if(resp.length > 0) {
						message.reply({ allowedMentions : { parse : []}, embeds : [embed]}).then(function(succ) {
							haxe_Log.trace("" + message.author.tag + " at " + format_date + " with file id:",{ fileName : "src/commands/Run2.hx", lineNumber : 358, className : "commands.Run2", methodName : "runCodeOnThread"});
							...
							haxe_Log.trace(err,{ fileName : "src/commands/Run2.hx", lineNumber : 366, className : "commands.Run2", methodName : "runCodeOnThread"});
							$global.console.dir(err);
						});
						haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 369, className : "commands.Run2", methodName : "runCodeOnThread"});
						return;
					}
					break;
				}
			...
			http.request(true);
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 410, className : "commands.Run2", methodName : "runCodeOnThread"});
			return;
		} catch( _g ) {
			haxe_NativeStackTrace.lastError = _g;
			var e = haxe_Exception.caught(_g).unwrap();
			haxe_Log.trace(e,{ fileName : "src/commands/Run2.hx", lineNumber : 580, className : "commands.Run2", methodName : "runCodeOnThread"});
		...
		while(_active && _g_idx >= 0) {
			...
			case 0:
				...
				if(StringTools.startsWith(message.content,"!run")) {
					haxe_Log.trace("here",{ fileName : "src/systems/MessageRouter.hx", lineNumber : 50, className : "systems.MessageRouter", methodName : "guildTextChannel"});
					var _ecsTmpEntity = this.universe.createEntity();
