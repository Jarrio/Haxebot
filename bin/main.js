				...
				if(this.event != null && this.event.status == 2) {
					...
					if(member.id == this.get_host() && updated.channel == null) {
						member.send("Hi <@" + this.get_host() + ">, it looks like you left the voice channel. Should I end the event?").then(function(message) {
							...
							haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 231, className : "commands.RoundupRoundup", methodName : "handleVoiceEvents"});
						});
					}
				}
				this.universe.deleteEntity(entity);
					...
					return function(guild) {
						guild.scheduledEvents.fetch(event[0].id).then((function() {
							return function(event) {
								...
								haxe_Log.trace("Updated event: " + event.status,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 173, className : "commands.RoundupRoundup", methodName : "handleEventUpdates"});
								haxe_Log.trace("New time: " + Std.string(new Date(event.scheduledStartTimestamp)),{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 174, className : "commands.RoundupRoundup", methodName : "handleEventUpdates"});
							};
						})(),(function() {
							return function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 175, className : "commands.RoundupRoundup", methodName : "handleEventUpdates"});
							};
						})());
					};
				})(event),(function() {
					return function(err) {
						haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 176, className : "commands.RoundupRoundup", methodName : "handleEventUpdates"});
					};
				})());
			}
			this.universe.deleteEntity(entity);
	...
	,handleEventStatus: function(event) {
		...
		case 2:
			if(this.get_state().announced || this.waiting) {
				haxe_Log.trace("here",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 190, className : "commands.RoundupRoundup", methodName : "handleEventStatus", customParams : [this.get_state().announced,this.waiting]});
				return;
			}
			...
			this.voice_text.send({ content : message, allowedMentions : { parse : ["everyone","roles"]}}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 206, className : "commands.RoundupRoundup", methodName : "handleEventStatus"});
			});
			this.get_state().announced = true;
			this.setState(this.get_state());
			haxe_Log.trace("Event Started",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 209, className : "commands.RoundupRoundup", methodName : "handleEventStatus"});
			this.waiting = false;
			this.event = event;
			break;
		case 3:
			...
			break;
		default:
			haxe_Log.trace(event.status,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 213, className : "commands.RoundupRoundup", methodName : "handleEventStatus"});
		}
	}
	...
	,endEventCollector: function(reaction,user) {
		...
		if(reaction.emoji.name == "✅") {
			this.event.setStatus(3,"Host ended the event.").then(function(event) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 252, className : "commands.RoundupRoundup", methodName : "endEventCollector"});
			});
		}
	...
	,handleScheduledEvent: function() {
			...
			if(now - this.last_checked > commands_types_Duration.fromString("1m")) {
				...
				while(!_g_lastStep.done) {
					...
					if(v.id == this.get_host()) {
						...
						haxe_Log.trace("Host is active",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 275, className : "commands.RoundupRoundup", methodName : "handleScheduledEvent"});
						break;
					}
				}
			} else {
		...
		if(left <= commands_types_Duration.fromString("0s") && !this.waiting && this.host_active) {
			...
			this.event.setStatus(2,"Time to start the event!").then(function(_) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 289, className : "commands.RoundupRoundup", methodName : "handleScheduledEvent"});
				_gthis.waiting = true;
			});
		}
	}
		...
		this.get_guild().scheduledEvents.create({ name : "Haxe Roundup Roundup", channel : this.voice_channel_id, entityType : 2, privacyLevel : 2, scheduledStartTime : date, description : "A community hosted discussion event where we go over the latest things that has gone on in the haxe over the last few weeks. We also have a period where people can show off what they're working on - its open floor come and join if you want :D"}).then(function(event) {
			...
			event.createInviteURL({ maxAge : 604800, channel : _gthis.voice_text_id}).then(function(url) {
				_gthis.voice_text.send({ content : "Thanks for hanging out :grin: \nGet ready for the next one! " + url}).then(null,function(err) {
					haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 315, className : "commands.RoundupRoundup", methodName : "createEvent"});
				});
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 320, className : "commands.RoundupRoundup", methodName : "createEvent"});
			});
			_gthis.setState(_gthis.get_state());
			haxe_Log.trace("Event setup!",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 322, className : "commands.RoundupRoundup", methodName : "createEvent"});
			...
			haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 327, className : "commands.RoundupRoundup", methodName : "createEvent"});
		});
	}
	,getEvent: function() {
		var _gthis = this;
		...
		this.get_schedule().fetch(this.get_state().event_id).then(function(event) {
			_gthis.waiting = false;
			haxe_Log.trace("Roundup event retrieved",{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 338, className : "commands.RoundupRoundup", methodName : "getEvent"});
			_gthis.event = event;
			_gthis.handleEventStatus(event);
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 342, className : "commands.RoundupRoundup", methodName : "getEvent"});
			_gthis.waiting = false;
		});
	}
	,handleEndEvent: function() {
		...
		while(_active && _g_idx >= 0) {
			...
			this.event.setStatus(3,"Host ended the event.").then((function(data) {
				...
				return function(err) {
					haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 354, className : "commands.RoundupRoundup", methodName : "handleEndEvent"});
				};
			})());
			this.universe.deleteEntity(entity);
		}
	...
	,addCollection: function(time,emojis,message,on_collect,on_end) {
		...
		while(_g < emojis.length) {
			...
			message.react(e).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupRoundup.hx", lineNumber : 363, className : "commands.RoundupRoundup", methodName : "addCollection"});
			});
		}
...
commands_Run2.prototype = $extend(systems_TextCommandBase.prototype,{
	...
	,onEnabled: function() {
		...
		http.onError = function(error) {
			haxe_Log.trace(error,{ fileName : "src/commands/Run2.hx", lineNumber : 54, className : "commands.Run2", methodName : "onEnabled"});
		};
		http.setPostData("{\r\n\t\t\t\t\"action\": \"haxe_version\"\r\n\t\t\t}");
		http.onData = function(response) {
			...
			if(parse.status == "Ok") {
				...
				haxe_Log.trace(parse.output,{ fileName : "src/commands/Run2.hx", lineNumber : 67, className : "commands.Run2", methodName : "onEnabled"});
				haxe_Log.trace(parse.error,{ fileName : "src/commands/Run2.hx", lineNumber : 68, className : "commands.Run2", methodName : "onEnabled"});
			}
		};
		http.request(true);
	}
	...
	,extractCode: function(message,response) {
		...
		if(check_code.match(message)) {
			...
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 101, className : "commands.Run2", methodName : "extractCode"});
			get_code.request();
			return;
		}
		check_code = new EReg("^(!run(\\s|\n| \n|)```(haxe|hx|)(.*)```)","gmisu");
		if(check_code.match(message)) {
			this.parse(check_code.matched(4),response);
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 109, className : "commands.Run2", methodName : "extractCode"});
			return;
		}
		check_code = new EReg("!run[\\s|\n| \n](.*)","gmis");
		if(check_code.match(message)) {
			this.parse(check_code.matched(1),response);
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 116, className : "commands.Run2", methodName : "extractCode"});
			return;
		}
		haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 119, className : "commands.Run2", methodName : "extractCode"});
		this.parse(null,response);
	}
	,extractLibs: function(code) {
		var check_code = new EReg("(/?/?-l\\W.*)","gmiu");
	...
	,parse: function(code,response) {
		if(code == null || code.length == 0) {
			response.reply({ content : "Your `!run` command formatting is incorrect. Check the pin in <#663246792426782730>."});
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 192, className : "commands.Run2", methodName : "parse"});
			return;
		}
		var class_exists = new EReg("(class.*({|\n{))","mgu");
		if(class_exists.match(code)) {
			...
			if(!check_class.match(code)) {
				response.reply({ content : "You must have a class called `Test` or `Main`"});
				haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 202, className : "commands.Run2", methodName : "parse"});
				return;
			}
		}
		haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 206, className : "commands.Run2", methodName : "parse"});
		this.runCodeOnThread(code,response);
	}
	,parseError: function(error,code) {
		var embed = new discord_$js_MessageEmbed();
	...
	,runCodeOnThread: function(code,message) {
		...
		haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 266, className : "commands.Run2", methodName : "runCodeOnThread"});
		try {
			var check_class = new EReg("(^class\\s(Test|Main)(\n|\\s|\\S))","mg");
			...
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 281, className : "commands.Run2", methodName : "runCodeOnThread"});
			code_content = format + "\n" + code_content;
			var http = new haxe_http_HttpNodeJs("http://" + this.site + ":1337");
			http.onError = function(error) {
				haxe_Log.trace(error,{ fileName : "src/commands/Run2.hx", lineNumber : 288, className : "commands.Run2", methodName : "runCodeOnThread"});
			};
			http.onData = function(response) {
				var parse = JSON.parse(response);
				haxe_Log.trace(response,{ fileName : "src/commands/Run2.hx", lineNumber : 293, className : "commands.Run2", methodName : "runCodeOnThread"});
				switch(parse.status) {
				case "OhNo":
					haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 374, className : "commands.Run2", methodName : "runCodeOnThread"});
					...
					haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 383, className : "commands.Run2", methodName : "runCodeOnThread"});
					if(embed == null) {
						haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 385, className : "commands.Run2", methodName : "runCodeOnThread"});
						message.reply({ allowedMentions : { parse : []}, content : mention + ("```\n" + compile_output + "```")});
					} else {
						haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 391, className : "commands.Run2", methodName : "runCodeOnThread"});
						message.reply({ allowedMentions : { parse : []}, embeds : [embed]});
					}
					break;
				case "Ok":
					...
					var format_date = DateTools.format(date,"%d-%m-%Y %H:%M:%S");
					embed.setFooter({ text : "Haxe " + _gthis.haxe_version, iconURL : "https://cdn.discordapp.com/emojis/567741748172816404.png?v=1"});
					haxe_Log.trace(resp,{ fileName : "src/commands/Run2.hx", lineNumber : 354, className : "commands.Run2", methodName : "runCodeOnThread"});
					haxe_Log.trace(parse,{ fileName : "src/commands/Run2.hx", lineNumber : 355, className : "commands.Run2", methodName : "runCodeOnThread"});
					if(resp.length > 0) {
						message.reply({ allowedMentions : { parse : []}, embeds : [embed]}).then(function(succ) {
							haxe_Log.trace("" + message.author.tag + " at " + format_date + " with file id:",{ fileName : "src/commands/Run2.hx", lineNumber : 359, className : "commands.Run2", methodName : "runCodeOnThread"});
							if(message.deletable) {
								message.delete().then(null,function(err) {
							...
							haxe_Log.trace(err,{ fileName : "src/commands/Run2.hx", lineNumber : 367, className : "commands.Run2", methodName : "runCodeOnThread"});
							$global.console.dir(err);
						});
						haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 370, className : "commands.Run2", methodName : "runCodeOnThread"});
						return;
					}
					break;
				}
			...
			http.request(true);
			haxe_Log.trace("hey",{ fileName : "src/commands/Run2.hx", lineNumber : 411, className : "commands.Run2", methodName : "runCodeOnThread"});
			return;
		} catch( _g ) {
			haxe_NativeStackTrace.lastError = _g;
			var e = haxe_Exception.caught(_g).unwrap();
			haxe_Log.trace(e,{ fileName : "src/commands/Run2.hx", lineNumber : 581, className : "commands.Run2", methodName : "runCodeOnThread"});
			this.channel.send({ content : mention + "Code failed to execute."});
		}
	}
	,get_base_path: function() {
...
var components_CommandOptions = $hxEnums["components.CommandOptions"] = { __ename__:"components.CommandOptions",__constructs__:null
	...
	,Everyone: ($_=function(content) { return {_hx_index:37,content:content,__enum__:"components.CommandOptions",toString:$estr,__params__:function(){ return [this.content];}}; },$_._hx_name="Everyone",$_)
	,Showcase: {_hx_name:"Showcase",_hx_index:38,__enum__:"components.CommandOptions",toString:$estr}
	,PinMessage: {_hx_name:"PinMessage",_hx_index:39,__enum__:"components.CommandOptions",toString:$estr}
	,Code: {_hx_name:"Code",_hx_index:40,__enum__:"components.CommandOptions",toString:$estr}
	,CodeLineNumbers: {_hx_name:"CodeLineNumbers",_hx_index:41,__enum__:"components.CommandOptions",toString:$estr}
};
...
systems_MessageRouter.prototype = $extend(ecs_System.prototype,{
		...
		while(_active && _g_idx >= 0) {
			...
			case 0:
				...
				if(StringTools.startsWith(message.content,"!run")) {
					...
					util_EcsTools.get_universe().components.set(entity6,0,"!run");
					...
					var ecsTmpFamily25 = util_EcsTools.get_universe().families.get(0);
					if(bits_Bits.areSet(ecsEntCompFlags5,ecsTmpFamily25.componentsMask)) {
						ecsTmpFamily25.add(entity6);
					}
					var ecsTmpFamily26 = util_EcsTools.get_universe().families.get(3);
					if(bits_Bits.areSet(ecsEntCompFlags5,ecsTmpFamily26.componentsMask)) {
						ecsTmpFamily26.add(entity6);
					}
					var ecsTmpFamily27 = util_EcsTools.get_universe().families.get(4);
					if(bits_Bits.areSet(ecsEntCompFlags5,ecsTmpFamily27.componentsMask)) {
						ecsTmpFamily27.add(entity6);
					}
				}
				this.universe.deleteEntity(entity);
				break;
			case 11:
				if(StringTools.startsWith(message.content,"[showcase]")) {
					...
					util_EcsTools.get_universe().components.set(entity7,5,"showcase");
					...
					if(bits_Bits.areSet(ecsEntCompFlags6,ecsTmpFamily32.componentsMask)) {
						ecsTmpFamily32.add(entity7);
					}
				}
				var entity8 = util_EcsTools.get_universe().createEntity();
				util_EcsTools.get_universe().components.set(entity8,5,"thread_count");
				util_EcsTools.get_universe().components.set(entity8,1,message);
				var ecsEntCompFlags7 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity8)];
	...
	,guildTextChannel: function(message) {
		...
		if(StringTools.startsWith(message.content,"!run")) {
			haxe_Log.trace("here",{ fileName : "src/systems/MessageRouter.hx", lineNumber : 51, className : "systems.MessageRouter", methodName : "guildTextChannel"});
			var entity = util_EcsTools.get_universe().createEntity();
			util_EcsTools.get_universe().components.set(entity,0,"!run");
			util_EcsTools.get_universe().components.set(entity,1,message);
			var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
			var ecsTmpFamily = util_EcsTools.get_universe().families.get(0);
			if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
