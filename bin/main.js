...
commands_ScamPrevention.prototype = $extend(systems_CommandBase.prototype,{
	...
	,multipleMessageCheck: function(uid) {
		...
		haxe_Log.trace("AvgTimePerMsg=" + avgTimePerMsg + " totalMsgs=" + totalMsgs + " timeDiff=" + timeDiff + " channels=" + channels.length,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 301, className : "commands.ScamPrevention", methodName : "multipleMessageCheck"});
		return true;
	}
	,update: function(_) {
		systems_CommandBase.prototype.update.call(this,_);
		...
		if(!(new Date().getTime() - this.phishing_update_time < 21600000)) {
			...
			links.onData = function(data) {
				try {
					...
					var _g1 = haxe_Exception.caught(_g);
					haxe_Log.trace(_g1,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 458, className : "commands.ScamPrevention", methodName : "getPhishingLinks"});
					haxe_Log.trace("error parsing phishing links",{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 459, className : "commands.ScamPrevention", methodName : "getPhishingLinks"});
		...
		while(_g_current < _g_length) {
			...
			haxe_Log.trace("Cleaned up history",{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 357, className : "commands.ScamPrevention", methodName : "update"});
		}
		...
		this.timeoutUser(message,function(_) {
			message.reply({ content : "<@&198916468312637440> Please review this message by: <@" + message.author.id + ">", embeds : [embed]}).then(function(_) {
				...
				while(_g < messages.length) {
					...
					++_g;
					message.delete().then(null,function(err) {
						haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 431, className : "commands.ScamPrevention", methodName : "reviewMessage"});
						$global.console.dir(err);
					});
				}
			},function(err) {
	...
	,timeoutUser: function(message,callback) {
		...
		message.guild.members.fetch(message.author.id).then(function(guild_member) {
			...
			guild_member.timeout(43200000,"Stop spamming, a mod will review this at their convenience.").then(callback,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 470, className : "commands.ScamPrevention", methodName : "timeoutUser"});
				$global.console.dir(err);
			});
			var id = message.author.id;
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 475, className : "commands.ScamPrevention", methodName : "timeoutUser"});
			$global.console.dir(err);
		});
	}
	...
	,banUser: function(messages,callback) {
		...
		message.guild.members.fetch(message.author.id).then(function(guild_member) {
			...
			guild_member.ban({ days : 1, reason : "found phishing links, auto banned."}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 504, className : "commands.ScamPrevention", methodName : "banUser"});
				$global.console.dir(err);
			});
			var id = message.author.id;
			var _this = _gthis.time_since;
			...
			message.channel.send("User <@" + message.author.id + "> has been auto banned for sending scam links.").then(callback,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 509, className : "commands.ScamPrevention", methodName : "banUser"});
				$global.console.dir(err);
			});
		},function(err) {
	...
	,logMessages: function(messages,action) {
		...
		Main.client.channels.fetch("952952631079362650").then(function(channel) {
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 533, className : "commands.ScamPrevention", methodName : "logMessages"});
			$global.console.dir(err);
		});
	}
	,logMessage: function(uid,embed,action) {
		...
		Main.client.channels.fetch("952952631079362650").then(function(channel) {
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 544, className : "commands.ScamPrevention", methodName : "logMessage"});
			$global.console.dir(err);
		});
	}
	...
	,hasKeyword: function(message) {
		...
		while(_g < _g1.length) {
			...
			if(message.toLowerCase().indexOf(keyword) != -1) {
				haxe_Log.trace(keyword,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 563, className : "commands.ScamPrevention", methodName : "hasKeyword"});
				return true;
			}
		}
		return false;
				...
				if(message.content.indexOf(link) != -1) {
					...
					if(regex.match(message.content)) {
						...
						if(url.hostname.length == 0 || url.hostname == null) {
							haxe_Log.trace(regex.matched(1),{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 590, className : "commands.ScamPrevention", methodName : "checkPhishingLinks"});
							return false;
						}
	...
	,checkTags: function(messages) {
		...
		while(_g < messages.length) {
			...
			if(message.content.indexOf("@everyone") != -1 || message.content.indexOf("@here") != -1) {
				if(tag_count >= 3) {
					haxe_Log.trace("here",{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 612, className : "commands.ScamPrevention", methodName : "checkTags"});
					break;
				}
				++tag_count;
			}
	...
	,checkEquality: function(messages) {
		...
		while(_g < messages.length) {
			...
			try {
				...
				haxe_Log.trace(_g2,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 641, className : "commands.ScamPrevention", methodName : "checkEquality"});
				haxe_Log.trace(JSON.stringify(messages),{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 642, className : "commands.ScamPrevention", methodName : "checkEquality"});
			}
		}
