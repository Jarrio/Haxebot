// Generated by Haxe 5.0.0-alpha.1+9d32634
...
Main.startup = function() {
	...
	if(!Main.got_state && !Main.startup_request) {
		haxe_Log.trace("Requested state",{ fileName : "src/Main.hx", lineNumber : 272, className : "Main", methodName : "startup"});
		...
		var e = database_DBEvents.GetAllRecords("state",function(response) {
			if(response._hx_index == 2) {
				...
				while(d.hasNext()) {
					...
					e("got " + (tmp == null ? "null" : Std.string(tmp)),{ fileName : "src/Main.hx", lineNumber : 284, className : "Main", methodName : "startup"});
				}
				haxe_Log.trace("State set",{ fileName : "src/Main.hx", lineNumber : 286, className : "Main", methodName : "startup"});
				Main.got_state = true;
				Main.startup_request = false;
				Main.discordClient();
			} else {
				haxe_Log.trace(response,{ fileName : "src/Main.hx", lineNumber : 291, className : "Main", methodName : "startup"});
			}
		});
	...
	if(!messages.enabled) {
		messages.enable();
		haxe_Log.trace("enabled phase \"messages\"",{ fileName : "src/Main.hx", lineNumber : 304, className : "Main", methodName : "startup"});
	}
	if(Main.commands_active) {
		Main.universe.getPhase("main").enable();
		haxe_Log.trace("enabled phase \"commands\"",{ fileName : "src/Main.hx", lineNumber : 316, className : "Main", methodName : "startup"});
	}
...
Main.discordClient = function() {
	...
	Main.client.once("ready",function() {
		...
		haxe_Log.trace("Ready!",{ fileName : "src/Main.hx", lineNumber : 340, className : "Main", methodName : "discordClient"});
		...
		res.then(function(foo) {
			...
			while(_g < foo.length) {
				var item = foo[_g];
				++_g;
				haxe_Log.trace("DEBUG - " + item.name + " is REGISTERED",{ fileName : "src/Main.hx", lineNumber : 349, className : "Main", methodName : "discordClient"});
			}
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 355, className : "Main", methodName : "discordClient"});
			$global.console.dir(err);
		});
	});
	Main.client.on("guildMemberAdd",function(member) {
		haxe_Log.trace("member " + member.user.tag,{ fileName : "src/Main.hx", lineNumber : 361, className : "Main", methodName : "discordClient"});
		var _ecsTmpEntity = Main.universe.createEntity();
	...
	Main.client.on("ChatInputAutoCompleteEvent",function(incoming) {
		haxe_Log.trace("disconnected",{ fileName : "src/Main.hx", lineNumber : 389, className : "Main", methodName : "discordClient"});
		haxe_Log.trace(incoming,{ fileName : "src/Main.hx", lineNumber : 390, className : "Main", methodName : "discordClient"});
	});
	...
	Main.client.on("interactionCreate",function(interaction) {
		...
		if(interaction.isModalSubmit()) {
			...
			case "quote_set":
				...
				break;
			default:
				haxe_Log.trace(interaction.customId,{ fileName : "src/Main.hx", lineNumber : 427, className : "Main", methodName : "discordClient"});
			}
			return;
		}
...
Main.saveCommand = function(command) {
	...
	haxe_Log.trace("registered " + command.name,{ fileName : "src/Main.hx", lineNumber : 582, className : "Main", methodName : "saveCommand"});
};
Main.main = function() {
	try {
		...
		haxe_Log.trace(e.get_message(),{ fileName : "src/Main.hx", lineNumber : 590, className : "Main", methodName : "main"});
	}
	...
	firebase_web_auth_Auth.signInWithEmailAndPassword(firebase_web_auth_Auth.getAuth(),Main.keys.username,Main.keys.password).then(function(res) {
		haxe_Log.trace("logged in",{ fileName : "src/Main.hx", lineNumber : 599, className : "Main", methodName : "main"});
		...
		firebase_web_firestore_Firestore.onSnapshot(doc,function(resp) {
			...
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 608, className : "Main", methodName : "main"});
			$global.console.dir(err);
		});
	});
	Main.start();
...
Main.updateState = function(field,value) {
	...
	var e = database_DBEvents.Update("state",NewState.get(Main.state,field),QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("key")),QueryExpr.QueryValue(field)),function(response) {
		if(response._hx_index == 4) {
			haxe_Log.trace("updated state field(" + field + ")",{ fileName : "src/Main.hx", lineNumber : 625, className : "Main", methodName : "updateState"});
		} else {
			haxe_Log.trace(NewState.get(Main.state,field),{ fileName : "src/Main.hx", lineNumber : 627, className : "Main", methodName : "updateState"});
			haxe_Log.trace(response,{ fileName : "src/Main.hx", lineNumber : 628, className : "Main", methodName : "updateState"});
		}
	});
	var _ecsTmpEntity = Main.universe.createEntity();
	Main.universe.components.set(_ecsTmpEntity,2,e);
...
commands_Poll.prototype = $extend(systems_CommandDbBase.prototype,{
	...
	,update: function(_) {
		...
		if(!this.checked && Main.discord_connected) {
			this.checked = true;
				...
				return interaction.fetchReply().then(function(message) {
					...
					firebase_web_firestore_Firestore.runTransaction(firebase_web_firestore_Firestore.getFirestore(firebase_web_app_FirebaseApp.getApp()),function(transaction) {
						...
						firebase_web_firestore_Firestore.addDoc(firebase_web_firestore_Firestore.collection(firebase_web_firestore_Firestore.getFirestore(firebase_web_app_FirebaseApp.getApp()),"discord/polls/entries"),data).then(function(_) {
							...
							haxe_Log.trace(err,{ fileName : "src/commands/Poll.hx", lineNumber : 158, className : "commands.Poll", methodName : "run"});
							$global.console.dir(err);
						});
					},function(err) {
	...
	,filter: function(message,data) {
		...
		var filter = function(reaction,user) {
			...
			haxe_Log.trace("removed " + reaction.message.author.tag + " reaction on message " + Std.string(reaction.message),{ fileName : "src/commands/Poll.hx", lineNumber : 286, className : "commands.Poll", methodName : "filter"});
			reaction.remove();
			return false;
		};
		return filter;
...
commands_RoundupAnnouncer.prototype = $extend(systems_CommandBase.prototype,{
	...
	,onEnabled: function() {
		...
		Main.client.channels.fetch(this.channel_id).then(function(ch) {
			if(ch != null) {
				_gthis.channel = ch;
				haxe_Log.trace("RoundupAnnouncer got channel",{ fileName : "src/commands/RoundupAnnouncer.hx", lineNumber : 17, className : "commands.RoundupAnnouncer", methodName : "onEnabled"});
			}
		});
	}
	,run: function(command,interaction) {
				...
				user.send({ content : "\n\t\t\t\t\tYou will be our roundup roundup announcer for this next event :) \n \nThe way this will work is, when the host of the roundup starts the event, you will be given permission to @everyone in the #voice-text channel. Feel free to add a message if you'd like, just don't use any other tag.\n\n\t\t\t\t\t\t\tYou will be dm'd on the day as a reminder! Thanks!\n\t\t\t\t"}).then(null,function(err) {
					...
					if((tmp != null ? tmp.message : null) != null) {
						...
						if(error.indexOf("Cannot send messages") != -1) {
							haxe_Log.trace("User has dms off",{ fileName : "src/commands/RoundupAnnouncer.hx", lineNumber : 43, className : "commands.RoundupAnnouncer", methodName : "run"});
							if(_gthis.channel != null) {
								_gthis.channel.send({ content : "<@" + user.id + "> Please open a DM channel with me"}).then(null,function(err) {
									haxe_Log.trace(err,{ fileName : "src/commands/RoundupAnnouncer.hx", lineNumber : 45, className : "commands.RoundupAnnouncer", methodName : "run"});
								});
							}
						}
					} else {
						haxe_Log.trace(JSON.stringify(err),{ fileName : "src/commands/RoundupAnnouncer.hx", lineNumber : 49, className : "commands.RoundupAnnouncer", methodName : "run"});
					}
				});
			}
		});
...
commands_ThreadCount.prototype = $extend(systems_CommandBase.prototype,{
	...
	,loadToDB: function() {
		...
		haxe_Log.trace(this.arr.length,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 102, className : "commands.ThreadCount", methodName : "loadToDB"});
		var timer = new haxe_Timer(200);
		timer.run = function() {
			haxe_Log.trace(_gthis.i,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 105, className : "commands.ThreadCount", methodName : "loadToDB"});
			...
			Main.client.channels.fetch(data.thread).then(function(ch) {
				...
				var e = database_DBEvents.Insert("threadcount",r,function(resp) {
					haxe_Log.trace(resp,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 121, className : "commands.ThreadCount", methodName : "loadToDB"});
				});
				var entity = util_EcsTools.get_universe().createEntity();
				util_EcsTools.get_universe().components.set(entity,2,e);
				var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
				...
				haxe_Log.trace(err,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 125, className : "commands.ThreadCount", methodName : "loadToDB"});
			});
			_gthis.i++;
		};
	}
	,run: function(command,interaction) {
		if(Object.prototype.hasOwnProperty.call(this.count.h,interaction.channelId)) {
			...
			interaction.reply({ content : "This thread has " + Std.string(count) + " messages"}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 134, className : "commands.ThreadCount", methodName : "run"});
				$global.console.dir(err);
			});
		} else {
			var content = "";
			...
			interaction.reply({ content : content}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 146, className : "commands.ThreadCount", methodName : "run"});
				$global.console.dir(err);
			});
		}
	}
	...
	,onEnabled: function() {
		...
		var e = database_DBEvents.GetAllRecords("trackers",function(resp) {
			if(resp._hx_index == 2) {
				...
				while(record.hasNext()) {
					...
					if(!Object.prototype.hasOwnProperty.call(_gthis.dm.h,tracker[0].by)) {
						Main.client.users.fetch(tracker[0].by).then((function(tracker) {
							return function(user) {
								haxe_Log.trace("added user " + user.tag,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 30, className : "commands.mod.Tracker", methodName : "onEnabled"});
				...
				haxe_Log.trace(resp,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 37, className : "commands.mod.Tracker", methodName : "onEnabled"});
			}
		});
		var _ecsTmpEntity = this.universe.createEntity();
		this.universe.components.set(_ecsTmpEntity,2,e);
					...
					if(this.findKeywords(message,tracker1)) {
						if(Object.prototype.hasOwnProperty.call(this.dm.h,tracker1.by)) {
							...
							this.dm.h[tracker1.by].send({ embeds : [embed]}).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 124, className : "commands.mod.Tracker", methodName : "update"});
							});
							continue;
						}
					}
	...
	,run: function(command,interaction) {
		...
		case 6:
			...
			while(_g_current < _g_array.length) {
				...
				string = StringTools.replace(string,"@","");
				string = StringTools.replace(string,"&","");
				haxe_Log.trace(string,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 265, className : "commands.mod.Tracker", methodName : "cleanDiscordThings"});
			...
			if(name != null) {
				if(interaction.isAutocomplete()) {
					var e = database_DBEvents.SearchBy("trackers","name",name,"by",interaction.user.id,function(resp) {
						if(resp._hx_index == 2) {
							...
							haxe_Log.trace(resp,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 198, className : "commands.mod.Tracker", methodName : "run"});
						}
					});
					var entity = util_EcsTools.get_universe().createEntity();
					var _ecsTmpEntity = entity;
				...
				var e = database_DBEvents.DeleteByValue("trackers","id",id,function(resp) {
					if(resp._hx_index == 4) {
						...
						haxe_Log.trace(resp,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 212, className : "commands.mod.Tracker", methodName : "run"});
					}
				});
				var entity = util_EcsTools.get_universe().createEntity();
				var _ecsTmpEntity = entity;
	...
	,parseTracker: function(interaction,name,description,keywords,string_exclude,channel_exclude,user_exclude) {
		...
		var e = database_DBEvents.Insert("trackers",obj,function(resp) {
			if(resp._hx_index == 4) {
				...
				haxe_Log.trace(resp,{ fileName : "src/commands/mod/Tracker.hx", lineNumber : 253, className : "commands.mod.Tracker", methodName : "parseTracker"});
			}
		});
		var entity = util_EcsTools.get_universe().createEntity();
		util_EcsTools.get_universe().components.set(entity,2,e);
		...
		while(_g < _g1) {
			...
			if(event[0] == null) {
				...
				case 3:
					...
					if(record[0].hasField("_insertedId")) {
