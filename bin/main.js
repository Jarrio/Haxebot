		...
		try {
			...
			http.onData = function(response) {
				...
				case "Ok":
					...
					var cdesc = "**Code:**\n```hx\n" + get_paths.code + "\n```";
					var odesc = "**Output:**\n ```markdown\n" + code_output + "```";
					haxe_Log.trace(cdesc.length,{ fileName : "src/commands/Run2.hx", lineNumber : 343, className : "commands.Run2", methodName : "runCodeOnThread"});
					haxe_Log.trace(odesc.length,{ fileName : "src/commands/Run2.hx", lineNumber : 344, className : "commands.Run2", methodName : "runCodeOnThread"});
					var embeds = [];
					if(truncate) {
					...
					if(resp.length > 0) {
						message.reply({ allowedMentions : { parse : []}, embeds : embeds}).then(function(succ) {
							haxe_Log.trace("" + message.author.tag + " at " + format_date + " with file id:",{ fileName : "src/commands/Run2.hx", lineNumber : 389, className : "commands.Run2", methodName : "runCodeOnThread"});
							if(message.deletable) {
								message.delete().then(null,function(err) {
									haxe_Log.trace(err,{ fileName : "src/commands/Run2.hx", lineNumber : 392, className : "commands.Run2", methodName : "runCodeOnThread"});
									$global.console.dir(err);
								});
							}
						},function(err) {
			...
			haxe_Log.trace(e,{ fileName : "src/commands/Run2.hx", lineNumber : 605, className : "commands.Run2", methodName : "runCodeOnThread"});
