...
Main.start = function() {
	...
	Main.client.on("messageCreate",function(message) {
		...
		if(match != null && match.charAt(0) == "!") {
			...
			while(_g < _g1.length) {
				...
				if(match == command) {
					...
					var ecsTmpFamily1 = Main.universe.families.get(4);
		...
		var _ecsTmpEntity = Main.universe.createEntity();
		Main.universe.components.set(_ecsTmpEntity,0,"keyword_tracker");
		Main.universe.components.set(_ecsTmpEntity,6,message);
		var ecsEntCompFlags = Main.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
		var ecsTmpFamily = Main.universe.families.get(0);
		if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
...
Main.saveCommand = function(command) {
	...
	haxe_Log.trace("registered " + command.name,{ fileName : "src/Main.hx", lineNumber : 458, className : "Main", methodName : "saveCommand"});
};
Main.main = function() {
	try {
		...
		haxe_Log.trace(e.get_message(),{ fileName : "src/Main.hx", lineNumber : 474, className : "Main", methodName : "main"});
	}
	...
	firebase_web_auth_Auth.signInWithEmailAndPassword(firebase_web_auth_Auth.getAuth(),Main.keys.username,Main.keys.password).then(function(res) {
		haxe_Log.trace("logged in",{ fileName : "src/Main.hx", lineNumber : 484, className : "Main", methodName : "main"});
		...
		firebase_web_firestore_Firestore.onSnapshot(doc,function(resp) {
			...
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 494, className : "Main", methodName : "main"});
			$global.console.dir(err);
		});
	});
	Main.start();
...
Main.updateState = function(field,value) {
	...
	firebase_web_firestore_Firestore.updateDoc(doc,field,value).then(null,function(err) {
		haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 506, className : "Main", methodName : "updateState"});
		$global.console.dir(err);
	});
};
...
commands_Trace.prototype = $extend(systems_CommandBase.prototype,{
	...
	,runCode: function(code,interaction) {
		...
		js_node_Fs.appendFile("" + this.get_base_path() + "/hx/" + filename + ".hx",final_code + ("\n//User:" + interaction.user.tag + " id: " + interaction.user.id + "| time: " + Std.string(new Date())),function(error) {
			...
			ls.stderr.once("data",function(data) {
				haxe_Log.trace("error: " + data,{ fileName : "src/commands/Trace.hx", lineNumber : 155, className : "commands.Trace", methodName : "runCode"});
...
var components_CommandOptions = $hxEnums["components.CommandOptions"] = { __ename__:"components.CommandOptions",__constructs__:null
	...
	,TrackerCreate: ($_=function(name,keywords,description,string_exclude,channel_exclude,user_exclude) { return {_hx_index:5,name:name,keywords:keywords,description:description,string_exclude:string_exclude,channel_exclude:channel_exclude,user_exclude:user_exclude,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="TrackerCreate",$_.__params__ = ["name","keywords","description","string_exclude","channel_exclude","user_exclude"],$_)
	,TrackerDelete: ($_=function(name) { return {_hx_index:6,name:name,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="TrackerDelete",$_.__params__ = ["name"],$_)
	,SnippetEdit: ($_=function(id) { return {_hx_index:7,id:id,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="SnippetEdit",$_.__params__ = ["id"],$_)
	,SnippetDelete: ($_=function(id) { return {_hx_index:8,id:id,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="SnippetDelete",$_.__params__ = ["id"],$_)
	,SnippetSearch: ($_=function(taga,tagb,tagc) { return {_hx_index:9,taga:taga,tagb:tagb,tagc:tagc,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="SnippetSearch",$_.__params__ = ["taga","tagb","tagc"],$_)
	,SnippetAdd: ($_=function(url,title,description,taga,tagb,tagc,tagd,tage) { return {_hx_index:10,url:url,title:title,description:description,taga:taga,tagb:tagb,tagc:tagc,tagd:tagd,tage:tage,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="SnippetAdd",$_.__params__ = ["url","title","description","taga","tagb","tagc","tagd","tage"],$_)
	,Reminder: ($_=function(content,when,personal,thread_reply) { return {_hx_index:11,content:content,when:when,personal:personal,thread_reply:thread_reply,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Reminder",$_.__params__ = ["content","when","personal","thread_reply"],$_)
	,Social: ($_=function(tag,user) { return {_hx_index:12,tag:tag,user:user,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Social",$_.__params__ = ["tag","user"],$_)
	,Ban: ($_=function(user,reason,delete_messages) { return {_hx_index:13,user:user,reason:reason,delete_messages:delete_messages,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Ban",$_.__params__ = ["user","reason","delete_messages"],$_)
	,Say: ($_=function(message,message_id) { return {_hx_index:14,message:message,message_id:message_id,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Say",$_.__params__ = ["message","message_id"],$_)
	,React: ($_=function(message_id,emoji) { return {_hx_index:15,message_id:message_id,emoji:emoji,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="React",$_.__params__ = ["message_id","emoji"],$_)
	,Helppls: ($_=function(topic) { return {_hx_index:16,topic:topic,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Helppls",$_.__params__ = ["topic"],$_)
	,Run: ($_=function(code) { return {_hx_index:17,code:code,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Run",$_.__params__ = ["code"],$_)
	,Trace: ($_=function(code) { return {_hx_index:18,code:code,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Trace",$_.__params__ = ["code"],$_)
	,Boop: ($_=function(user) { return {_hx_index:19,user:user,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Boop",$_.__params__ = ["user"],$_)
	,Poll: ($_=function(question,length,a,b,c,d,e,f,g,votes) { return {_hx_index:20,question:question,length:length,a:a,b:b,c:c,d:d,e:e,f:f,g:g,votes:votes,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Poll",$_.__params__ = ["question","length","a","b","c","d","e","f","g","votes"],$_)
	,Roundup: ($_=function(number) { return {_hx_index:21,number:number,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Roundup",$_.__params__ = ["number"],$_)
	,Rtfm: ($_=function(channel) { return {_hx_index:22,channel:channel,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Rtfm",$_.__params__ = ["channel"],$_)
	,Translate: ($_=function(to,message,from) { return {_hx_index:23,to:to,message:message,from:from,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Translate",$_.__params__ = ["to","message","from"],$_)
	,Helpdescription: ($_=function(description) { return {_hx_index:24,description:description,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Helpdescription",$_.__params__ = ["description"],$_)
	,Api: ($_=function(content,field) { return {_hx_index:25,content:content,field:field,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Api",$_.__params__ = ["content","field"],$_)
	,Notify: ($_=function(channel) { return {_hx_index:26,channel:channel,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Notify",$_.__params__ = ["channel"],$_)
	,Help: ($_=function(category) { return {_hx_index:27,category:category,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Help",$_.__params__ = ["category"],$_)
	,Haxelib: ($_=function(command) { return {_hx_index:28,command:command,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Haxelib",$_.__params__ = ["command"],$_)
	,QuoteList: ($_=function(user) { return {_hx_index:29,user:user,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="QuoteList",$_.__params__ = ["user"],$_)
	,QuoteGet: ($_=function(name) { return {_hx_index:30,name:name,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="QuoteGet",$_.__params__ = ["name"],$_)
	,QuoteDelete: ($_=function(name) { return {_hx_index:31,name:name,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="QuoteDelete",$_.__params__ = ["name"],$_)
	,QuoteEdit: ($_=function(name) { return {_hx_index:32,name:name,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="QuoteEdit",$_.__params__ = ["name"],$_)
	,QuoteCreate: ($_=function(name) { return {_hx_index:33,name:name,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="QuoteCreate",$_.__params__ = ["name"],$_)
	,Mention: ($_=function(user,role) { return {_hx_index:34,user:user,role:role,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Mention",$_.__params__ = ["user","role"],$_)
	,Showcase: {_hx_name:"Showcase",_hx_index:35,__enum__:"components.CommandOptions",toString:$estr}
	,PinMessage: {_hx_name:"PinMessage",_hx_index:36,__enum__:"components.CommandOptions",toString:$estr}
	,Code: {_hx_name:"Code",_hx_index:37,__enum__:"components.CommandOptions",toString:$estr}
	,CodeLineNumbers: {_hx_name:"CodeLineNumbers",_hx_index:38,__enum__:"components.CommandOptions",toString:$estr}
};
