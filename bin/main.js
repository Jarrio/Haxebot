...
systems_commands_Api.prototype = $extend(systems_CommandBase.prototype,{
	...
	,extractDoxData: function(info,message) {
		...
		http.onData = function(resp) {
			var body = NodeHtmlParser.parse(resp).querySelector(".span9");
			haxe_Log.trace(body.innerHTML,{ fileName : "src/systems/commands/Api.hx", lineNumber : 65, className : "systems.commands.Api", methodName : "extractDoxData"});
			if(body == null) {
				return;
			}
			...
			var reply_body = "";
			haxe_Log.trace(body.querySelectorAll(".fields").length,{ fileName : "src/systems/commands/Api.hx", lineNumber : 80, className : "systems.commands.Api", methodName : "extractDoxData"});
			var _g_current = 0;
			...
			while(_g_current < _g_array.length) {
				...
				while(_g < _g1.length) {
					...
					if(id_check.match(field.innerHTML) && id_check.matched(1).toLowerCase() == info.identifier.toLowerCase()) {
						...
						message.reply(embed);
						haxe_Log.trace("posted",{ fileName : "src/systems/commands/Api.hx", lineNumber : 107, className : "systems.commands.Api", methodName : "extractDoxData"});
						return;
					}
				}
			}
			...
			if(reply_body.length > 0) {
				embed.setDescription(StringTools.htmlUnescape(reply_body));
				haxe_Log.trace("posted",{ fileName : "src/systems/commands/Api.hx", lineNumber : 119, className : "systems.commands.Api", methodName : "extractDoxData"});
				message.reply(embed);
			}
		};
...
systems_commands_Run.prototype = $extend(systems_CommandBase.prototype,{
	...
	,deleteFile: function(filename) {
		try {
			...
			var _g1 = haxe_Exception.caught(_g).unwrap();
			haxe_Log.trace(_g1,{ fileName : "src/systems/commands/Run.hx", lineNumber : 75, className : "systems.commands.Run", methodName : "deleteFile"});
		}
	}
	...
	,runCodeOnThread: function(code,message) {
		...
		try {
			...
			js_node_Fs.appendFile("" + this.get_base_path() + "/hx/" + filename + ".hx",code_content + ("//User:" + message.author.username + " | time: " + Std.string(new Date())),function(error) {
				if(error != null) {
					haxe_Log.trace(error,{ fileName : "src/systems/commands/Run.hx", lineNumber : 233, className : "systems.commands.Run", methodName : "runCodeOnThread"});
				}
				...
				ls.stderr.once("data",function(data) {
					haxe_Log.trace("error: " + data,{ fileName : "src/systems/commands/Run.hx", lineNumber : 258, className : "systems.commands.Run", methodName : "runCodeOnThread"});
				...
				ls.once("close",function(data) {
					...
					if(!sys_FileSystem.exists(js_file)) {
						haxe_Log.trace("Code likely errored and didnt compile (" + filename + ".js)",{ fileName : "src/systems/commands/Run.hx", lineNumber : 269, className : "systems.commands.Run", methodName : "runCodeOnThread"});
						ls.kill("SIGTERM");
						return;
					}
					var $process = js_node_ChildProcess.spawn("node",[js_file],{ timeout : 10000});
					$process.stdout.on("data",function(data) {
						data = _gthis.cleanOutput(data,filename,class_entry);
						haxe_Log.trace(data,{ fileName : "src/systems/commands/Run.hx", lineNumber : 277, className : "systems.commands.Run", methodName : "runCodeOnThread"});
						response = data;
						return response;
					});
					$process.stderr.on("data",function(data) {
						haxe_Log.trace("error: " + data,{ fileName : "src/systems/commands/Run.hx", lineNumber : 284, className : "systems.commands.Run", methodName : "runCodeOnThread"});
					});
					$process.once("close",function(data) {
						haxe_Log.trace("close: " + data,{ fileName : "src/systems/commands/Run.hx", lineNumber : 288, className : "systems.commands.Run", methodName : "runCodeOnThread"});
						...
						var output_numbers = [];
						var output_lines = [];
						var regex = new EReg("^(.*\\.hx:)(\\d*:)(.*)","gmiu");
						var embed = new discord_$js_MessageEmbed();
						embed.type = "article";
						while(regex.match(response)) {
							output_numbers.push(regex.matched(2));
							output_lines.push(StringTools.replace(regex.matched(3),"\n"," "));
						...
						if(response.length > 0 && data == 0) {
							...
							message.delete().then(function(_) {
								...
								haxe_Log.trace(err,{ fileName : "src/systems/commands/Run.hx", lineNumber : 350, className : "systems.commands.Run", methodName : "runCodeOnThread"});
							});
							return;
						}
					});
			...
			haxe_NativeStackTrace.lastError = _g;
			var _g1 = haxe_Exception.caught(_g).unwrap();
			haxe_Log.trace(_g1,{ fileName : "src/systems/commands/Run.hx", lineNumber : 359, className : "systems.commands.Run", methodName : "runCodeOnThread"});
