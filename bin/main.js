// Generated by Haxe 5.0.0-preview.1+35cbcb5
...
Main.start = function() {
	...
	vec[1] = new ecs_Phase(false,"messages",new Array(7),new Array(7));
	...
	var s = new commands_MessageCounter(u);
	phase.systems[2] = s;
...
Main.startup = function() {
	...
	if(!Main.got_state && !Main.startup_request) {
		...
		Main.universe.components.set(_ecsTmpEntity,5,e);
...
Main.discordClient = function() {
	...
	Main.client.on("guildScheduledEventCreate",function(event) {
		var _ecsTmpEntity = Main.universe.createEntity();
		Main.universe.components.set(_ecsTmpEntity,2,"create_event");
	...
	Main.client.on("guildScheduledEventUpdate",function(event) {
		var _ecsTmpEntity = Main.universe.createEntity();
		Main.universe.components.set(_ecsTmpEntity,2,"scheduled_event_update");
		Main.universe.components.set(_ecsTmpEntity,11,event);
		var ecsEntCompFlags = Main.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
		var ecsTmpFamily = Main.universe.families.get(1);
		if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
	...
	Main.client.on("voiceStateUpdate",function(old,updated) {
		var _ecsTmpEntity = Main.universe.createEntity();
		Main.universe.components.set(_ecsTmpEntity,2,"roundup_member_update");
	...
	Main.client.on("messageCreate",function(message) {
		...
		var _ecsTmpEntity = Main.universe.createEntity();
		Main.universe.components.set(_ecsTmpEntity,2,"new_message");
	...
	Main.client.on("threadCreate",function(thread) {
		var _ecsTmpEntity = Main.universe.createEntity();
		Main.universe.components.set(_ecsTmpEntity,2,"thread_pin_message");
	...
	Main.client.on("interactionCreate",function(interaction) {
		if(interaction.isButton()) {
			...
			if(interaction.customId == "snippet_left") {
				var _ecsTmpEntity = Main.universe.createEntity();
				Main.universe.components.set(_ecsTmpEntity,2,"snippet_left");
				Main.universe.components.set(_ecsTmpEntity,1,interaction);
				var ecsEntCompFlags = Main.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
				var ecsTmpFamily = Main.universe.families.get(1);
				if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
			...
			if(interaction.customId == "snippet_right") {
				var _ecsTmpEntity = Main.universe.createEntity();
				Main.universe.components.set(_ecsTmpEntity,2,"snippet_right");
				Main.universe.components.set(_ecsTmpEntity,1,interaction);
				var ecsEntCompFlags = Main.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
				var ecsTmpFamily = Main.universe.families.get(1);
				if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
		...
		if(interaction.isModalSubmit()) {
			...
			case "code_paste":
				var _ecsTmpEntity = Main.universe.createEntity();
				Main.universe.components.set(_ecsTmpEntity,2,"code_paste");
				Main.universe.components.set(_ecsTmpEntity,1,interaction);
				var ecsEntCompFlags = Main.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
				var ecsTmpFamily = Main.universe.families.get(1);
				if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
			...
			case "emoji_edit":
				var _ecsTmpEntity = Main.universe.createEntity();
				Main.universe.components.set(_ecsTmpEntity,2,"emoji_edit");
				Main.universe.components.set(_ecsTmpEntity,1,interaction);
				var ecsEntCompFlags = Main.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
				var ecsTmpFamily = Main.universe.families.get(1);
				if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
...
commands_Emoji.prototype = $extend(systems_CommandBase.prototype,{
				...
				var e = database_DBEvents.GetRecord("emojis",QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("url")),QueryExpr.QueryValue(url)),(function(emoji,interaction) {
					return function(resp) {
						if(resp._hx_index == 1) {
							...
							util_EcsTools.get_universe().components.set(_ecsTmpEntity,5,e);
	...
	,search: function(name,callback) {
		...
		var entity = util_EcsTools.get_universe().createEntity();
		util_EcsTools.get_universe().components.set(entity,5,e);
...
var commands_MessageCounter = function(_universe) {
...
$hxClasses["commands.MessageCounter"] = commands_MessageCounter;
commands_MessageCounter.__name__ = "commands.MessageCounter";
commands_MessageCounter.__super__ = systems_CommandBase;
commands_MessageCounter.prototype = $extend(systems_CommandBase.prototype,{
	loaded: null
	,count: null
	,path: null
	,onEnabled: function() {
	...
	,loadCounts: function() {
		var _gthis = this;
		var e = database_DBEvents.GetAllRecords("message_counter",function(resp) {
			if(resp._hx_index == 2) {
				...
				while(item.hasNext()) {
					...
					if(item1.hasField("_insertedId")) {
						...
						haxe_Log.trace("removed a field",{ fileName : "src/commands/MessageCounter.hx", lineNumber : 35, className : "commands.MessageCounter", methodName : "loadCounts"});
					}
					var r = database_types_DBMessageCounter.fromRecord(item1);
					_gthis.count.h[r.userId] = r;
				}
				_gthis.loaded = true;
				haxe_Log.trace("Loaded user message counts",{ fileName : "src/commands/MessageCounter.hx", lineNumber : 41, className : "commands.MessageCounter", methodName : "loadCounts"});
			} else {
				haxe_Log.trace(resp,{ fileName : "src/commands/MessageCounter.hx", lineNumber : 43, className : "commands.MessageCounter", methodName : "loadCounts"});
			}
		});
		var _ecsTmpEntity = this.universe.createEntity();
		this.universe.components.set(_ecsTmpEntity,5,e);
			...
			if(command == "message_counter") {
				...
				if(Object.prototype.hasOwnProperty.call(this.count.h,userId)) {
					...
					try {
						...
						var entity1 = util_EcsTools.get_universe().createEntity();
						util_EcsTools.get_universe().components.set(entity1,5,e);
...
commands_Notify.prototype = $extend(systems_CommandBase.prototype,{
	...
	,run: function(command,interaction) {
		...
		if(_g._hx_index == 32) {
			...
			if(role == "err") {
				haxe_Log.trace(channel,{ fileName : "src/commands/Notify.hx", lineNumber : 44, className : "commands.Notify", methodName : "run"});
				haxe_Log.trace(interaction.command,{ fileName : "src/commands/Notify.hx", lineNumber : 45, className : "commands.Notify", methodName : "run"});
			...
			if(resp._hx_index == 2) {
				...
				while(record.hasNext()) {
					...
					if(poll[0].active != 1) {
						...
						var _ecsTmpEntity = _gthis.universe.createEntity();
						_gthis.universe.components.set(_ecsTmpEntity,5,e);
						var ecsEntCompFlags = _gthis.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
...
commands_Quote.prototype = $extend(systems_CommandBase.prototype,{
	...
	,update: function(_) {
		...
		while(_g_active && _g_idx >= 0) {
				...
				var e = database_DBEvents.GetRecord("quotes",QueryExpr.QueryBinop(QBinop.QOpBoolAnd,QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("title")),QueryExpr.QueryValue(title[0])),QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("author_id")),QueryExpr.QueryValue(interaction[0].user.id))),(function(title,quote,interaction) {
					return function(resp) {
						if(resp._hx_index == 1) {
							...
							haxe_Log.trace(title[0],{ fileName : "src/commands/Quote.hx", lineNumber : 75, className : "commands.Quote", methodName : "update"});
							haxe_Log.trace(quote[0].title,{ fileName : "src/commands/Quote.hx", lineNumber : 76, className : "commands.Quote", methodName : "update"});
							if(data != null && title[0] != quote[0].title) {
								interaction[0].reply("You already have a quote with the title **__" + title[0] + "__**").then(null,(function() {
									return function(err) {
										haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 82, className : "commands.Quote", methodName : "update"});
										$global.console.dir(err);
									};
								})());
								return;
							...
							var e = database_DBEvents.Update("quotes",quote[0],QueryExpr.QueryBinop(QBinop.QOpBoolAnd,QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("id")),QueryExpr.QueryValue(quote[0].id)),QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("author_id")),QueryExpr.QueryValue(quote[0].author_id))),(function(interaction) {
								return function(resp) {
									if(resp._hx_index == 4) {
										var message = resp.message;
										haxe_Log.trace("" + message,{ fileName : "src/commands/Quote.hx", lineNumber : 95, className : "commands.Quote", methodName : "update"});
										interaction[0].reply("Quote updated!");
									} else {
										haxe_Log.trace(_gthis.cache.h[interaction[0].user.id],{ fileName : "src/commands/Quote.hx", lineNumber : 98, className : "commands.Quote", methodName : "update"});
										interaction[0].reply("Something went wrong");
										haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 100, className : "commands.Quote", methodName : "update"});
									}
									var key = interaction[0].user.id;
									var _this = _gthis.cache;
									if(Object.prototype.hasOwnProperty.call(_this.h,key)) {
							...
							haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 107, className : "commands.Quote", methodName : "update"});
						}
					};
			...
			case "quote_set":
				...
				util_EcsTools.get_universe().components.set(_ecsTmpEntity1,5,e1);
	...
	,parseGroupQuotes: function(interaction,value) {
		if(value._hx_index == 2) {
			...
			interaction.reply({ embeds : [embed]}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 137, className : "commands.Quote", methodName : "parseGroupQuotes"});
			});
		} else {
			haxe_Log.trace(value,{ fileName : "src/commands/Quote.hx", lineNumber : 139, className : "commands.Quote", methodName : "parseGroupQuotes"});
		}
	}
	,run: function(command,interaction) {
		var _gthis = this;
			...
			if(interaction.isAutocomplete() && type != "get") {
				var e = database_DBEvents.SearchBy("quotes",column,name,"author_id",interaction.user.id,function(resp) {
					if(resp._hx_index == 2) {
						...
						haxe_Log.trace(name,{ fileName : "src/commands/Quote.hx", lineNumber : 209, className : "commands.Quote", methodName : "run"});
						if(!interaction.responded) {
							interaction.respond(res).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 212, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
							});
						}
					} else {
						haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 217, className : "commands.Quote", methodName : "run"});
					}
				});
				var entity = util_EcsTools.get_universe().createEntity();
				var _ecsTmpEntity = entity;
			...
			case "delete":
				...
				var e = database_DBEvents.DeleteRecord("quotes",record,function(resp) {
					...
					case 5:
						var message = resp.message;
						var data = resp.data;
						haxe_Log.trace(message,{ fileName : "src/commands/Quote.hx", lineNumber : 340, className : "commands.Quote", methodName : "run"});
						haxe_Log.trace(data == null ? "null" : Std.string(data),{ fileName : "src/commands/Quote.hx", lineNumber : 341, className : "commands.Quote", methodName : "run"});
						...
						break;
					default:
						haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 348, className : "commands.Quote", methodName : "run"});
					}
				});
				var entity = util_EcsTools.get_universe().createEntity();
				var _ecsTmpEntity = entity;
			...
			case "edit":
				var e = database_DBEvents.GetRecord("quotes",QueryExpr.QueryBinop(QBinop.QOpBoolAnd,QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("id")),QueryExpr.QueryValue(name)),QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("author_id")),QueryExpr.QueryValue(interaction.user.id))),function(resp) {
					if(resp._hx_index == 1) {
						...
						haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 324, className : "commands.Quote", methodName : "run"});
					}
				});
				var entity = util_EcsTools.get_universe().createEntity();
				var _ecsTmpEntity = entity;
						...
						if(name != null && name.length > 0) {
							if(qid != null && qid > 0) {
								e = database_DBEvents.GetRecord("quotes",QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("id")),QueryExpr.QueryValue(qid)),function(response) {
									haxe_Log.trace(name,{ fileName : "src/commands/Quote.hx", lineNumber : 363, className : "commands.Quote", methodName : "run"});
									if(response._hx_index == 1) {
										...
										interaction.respond(results).then(null,function(err) {
											haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 377, className : "commands.Quote", methodName : "run"});
											$global.console.dir(err);
										});
									} else {
										haxe_Log.trace(response,{ fileName : "src/commands/Quote.hx", lineNumber : 381, className : "commands.Quote", methodName : "run"});
									}
								});
							} else {
								e = database_DBEvents.Search("quotes","title",name,function(response) {
									if(response._hx_index == 2) {
										...
										interaction.respond(results).then(null,function(err) {
											haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 399, className : "commands.Quote", methodName : "run"});
											$global.console.dir(err);
										});
									} else {
										haxe_Log.trace(response,{ fileName : "src/commands/Quote.hx", lineNumber : 403, className : "commands.Quote", methodName : "run"});
									}
								});
							}
							var _ecsTmpEntity = this.universe.createEntity();
							...
							interaction.respond([]).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 411, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
							});
							return;
						}
						...
						if(resp._hx_index == 1) {
							...
							if(data == null) {
								interaction.reply("Could not find any quotes with that identifier").then(null,function(err) {
									haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 425, className : "commands.Quote", methodName : "run"});
								});
								return;
							}
							...
							interaction.reply({ embeds : [embed]}).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 450, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
							});
						} else {
							haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 454, className : "commands.Quote", methodName : "run"});
						}
					});
					var entity = util_EcsTools.get_universe().createEntity();
					var _ecsTmpEntity = entity;
					...
					if(resp._hx_index == 2) {
						...
						if(data.get_length() >= 1) {
							...
							interaction1.reply("You already have a quote with the title __" + (tmp == null ? "null" : Std.string(tmp)) + "__").then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 246, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
							});
							return;
						}
						...
						haxe_Log.trace(resp,{ fileName : "src/commands/Quote.hx", lineNumber : 277, className : "commands.Quote", methodName : "run"});
					}
				});
				var entity = util_EcsTools.get_universe().createEntity();
				var _ecsTmpEntity = entity;
			...
			if(interaction.isAutocomplete() && type != "get") {
				var e = database_DBEvents.SearchBy("quotes",column,name1,"author_id",interaction.user.id,function(resp) {
					if(resp._hx_index == 2) {
						...
						haxe_Log.trace(name1,{ fileName : "src/commands/Quote.hx", lineNumber : 209, className : "commands.Quote", methodName : "run"});
						if(!interaction.responded) {
							interaction.respond(res).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 212, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
				...
				if(name1 != null) {
					...
					if(interaction.isAutocomplete()) {
						...
						if(name1 != null && name1.length > 0) {
							if(qid != null && qid > 0) {
								e = database_DBEvents.GetRecord("quotes",QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("id")),QueryExpr.QueryValue(qid)),function(response) {
									haxe_Log.trace(name1,{ fileName : "src/commands/Quote.hx", lineNumber : 363, className : "commands.Quote", methodName : "run"});
									if(response._hx_index == 1) {
										var data = response.data;
										if(data == null) {
											interaction.respond([]);
			...
			if(interaction.isAutocomplete() && type != "get") {
				var e = database_DBEvents.SearchBy("quotes",column,name2,"author_id",interaction.user.id,function(resp) {
					if(resp._hx_index == 2) {
						...
						haxe_Log.trace(name2,{ fileName : "src/commands/Quote.hx", lineNumber : 209, className : "commands.Quote", methodName : "run"});
						if(!interaction.responded) {
							interaction.respond(res).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 212, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
				...
				if(name2 != null) {
					...
					if(interaction.isAutocomplete()) {
						...
						if(name2 != null && name2.length > 0) {
							if(qid != null && qid > 0) {
								e = database_DBEvents.GetRecord("quotes",QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("id")),QueryExpr.QueryValue(qid)),function(response) {
									haxe_Log.trace(name2,{ fileName : "src/commands/Quote.hx", lineNumber : 363, className : "commands.Quote", methodName : "run"});
									if(response._hx_index == 1) {
										var data = response.data;
										if(data == null) {
											interaction.respond([]);
			...
			if(interaction.isAutocomplete() && type != "get") {
				var e = database_DBEvents.SearchBy("quotes",column,name3,"author_id",interaction.user.id,function(resp) {
					if(resp._hx_index == 2) {
						...
						haxe_Log.trace(name3,{ fileName : "src/commands/Quote.hx", lineNumber : 209, className : "commands.Quote", methodName : "run"});
						if(!interaction.responded) {
							interaction.respond(res).then(null,function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Quote.hx", lineNumber : 212, className : "commands.Quote", methodName : "run"});
								$global.console.dir(err);
				...
				if(name3 != null) {
					...
					if(interaction.isAutocomplete()) {
						...
						if(name3 != null && name3.length > 0) {
							if(qid != null && qid > 0) {
								e = database_DBEvents.GetRecord("quotes",QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("id")),QueryExpr.QueryValue(qid)),function(response) {
									haxe_Log.trace(name3,{ fileName : "src/commands/Quote.hx", lineNumber : 363, className : "commands.Quote", methodName : "run"});
									if(response._hx_index == 1) {
										var data = response.data;
										if(data == null) {
											interaction.respond([]);
...
commands_RoundupPoster.prototype = $extend(systems_CommandBase.prototype,{
	...
	,getHaxeIoPage: function() {
		...
		data.onData = function(body) {
			var regex = new EReg("### News and Articles(.*?)### People & Projects to support","gmis");
			if(regex.match(body)) {
				...
				haxe_Log.trace("[Error] No content found",{ fileName : "src/commands/RoundupPoster.hx", lineNumber : 109, className : "commands.RoundupPoster", methodName : "getHaxeIoPage"});
			}
		};
		data.request();
	}
	...
	,update: function(_) {
		...
		if(this.channel == null && this.checking == false) {
			...
			Main.client.channels.fetch(this.announcement_channel).then(function(channel) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupPoster.hx", lineNumber : 130, className : "commands.RoundupPoster", methodName : "update"});
				$global.console.dir(err);
			});
			var h = this.dmlist.h;
			var _g_h = h;
				...
				if(user == null) {
					Main.client.users.fetch(key1[0]).then((function(key) {
						return function(user) {
							...
							haxe_Log.trace("Got " + user.tag,{ fileName : "src/commands/RoundupPoster.hx", lineNumber : 138, className : "commands.RoundupPoster", methodName : "update"});
						};
					})(key1),(function() {
						return function(err) {
							haxe_Log.trace(err,{ fileName : "src/commands/RoundupPoster.hx", lineNumber : 139, className : "commands.RoundupPoster", methodName : "update"});
						};
					})());
				}
			}
		...
		if(diff >= 86400000) {
			haxe_Log.trace("Attempt to post roundup! " + NewState.get_next_roundup(Main.state),{ fileName : "src/commands/RoundupPoster.hx", lineNumber : 151, className : "commands.RoundupPoster", methodName : "update"});
	...
	,run: function(command,interaction) {
		...
		if(_g._hx_index == 27) {
			...
			interaction.client.channels.fetch(this.announcement_channel).then(function(channel) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/RoundupPoster.hx", lineNumber : 211, className : "commands.RoundupPoster", methodName : "run"});
				$global.console.dir(err);
			});
		}
	}
...
var systems_TextCommandBase = function(_universe) {
	...
	this.tabled1cd3067ebd0108e92f1425a40ea7b45 = this.universe.components.getTable(3);
	this.tablee699e73f96d5fb19e01669534fb74875 = this.universe.components.getTable(4);
};
...
commands_ScamPrevention.prototype = $extend(systems_CommandBase.prototype,{
	...
	,multipleMessageCheck: function(uid) {
		...
		while(_g < _g1.length) {
			...
			haxe_Log.trace(channel.isThread(),{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 296, className : "commands.ScamPrevention", methodName : "multipleMessageCheck", customParams : [channel.name]});
			channel.isThread();
		...
		if(!(new Date().getTime() - this.phishing_update_time < 21600000)) {
			...
			links.onData = function(data) {
				try {
					...
					var _g1 = haxe_Exception.caught(_g);
					haxe_Log.trace(_g1,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 472, className : "commands.ScamPrevention", methodName : "getPhishingLinks"});
					haxe_Log.trace("error parsing phishing links",{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 473, className : "commands.ScamPrevention", methodName : "getPhishingLinks"});
		...
		this.timeoutUser(message,logMessage,function(_) {
			message.reply({ content : "<@&198916468312637440> Please review this message by: <@" + message.author.id + ">", embeds : [embed]}).then(function(_) {
				...
				while(_g < messages.length) {
					...
					++_g;
					message.delete().then(null,function(err) {
						haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 444, className : "commands.ScamPrevention", methodName : "reviewMessage"});
						$global.console.dir(err);
					});
				}
			},function(err) {
				haxe_Log.trace(message.content,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 449, className : "commands.ScamPrevention", methodName : "reviewMessage"});
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 450, className : "commands.ScamPrevention", methodName : "reviewMessage"});
				$global.console.dir(err);
			});
		});
	}
	...
	,timeoutUser: function(message,logMessage,callback) {
		...
		message.guild.members.fetch(message.author.id).then(function(guild_member) {
			...
			guild_member.timeout(43200000,"Stop spamming, a mod will review this at their convenience.").then(callback,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 486, className : "commands.ScamPrevention", methodName : "timeoutUser"});
				haxe_Log.trace("AuthorId=" + message.author.id + " User=" + message.author.displayName,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 487, className : "commands.ScamPrevention", methodName : "timeoutUser"});
				haxe_Log.trace(message.content,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 488, className : "commands.ScamPrevention", methodName : "timeoutUser"});
				$global.console.dir(err);
			});
			var id = message.author.id;
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 493, className : "commands.ScamPrevention", methodName : "timeoutUser"});
			$global.console.dir(err);
		});
	}
	...
	,banUser: function(messages,callback) {
		...
		message.guild.members.fetch(message.author.id).then(function(guild_member) {
			...
			guild_member.ban({ days : 1, reason : "found phishing links, auto banned."}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 522, className : "commands.ScamPrevention", methodName : "banUser"});
				$global.console.dir(err);
			});
			var id = message.author.id;
			var _this = _gthis.time_since;
			...
			message.channel.send("User <@" + message.author.id + "> has been auto banned for sending scam links.").then(callback,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 527, className : "commands.ScamPrevention", methodName : "banUser"});
				$global.console.dir(err);
			});
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 531, className : "commands.ScamPrevention", methodName : "banUser"});
			$global.console.dir(err);
		});
	}
	,logMessages: function(messages,action) {
		...
		Main.client.channels.fetch(this.logChannelId).then(function(channel) {
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 549, className : "commands.ScamPrevention", methodName : "logMessages"});
			$global.console.dir(err);
		});
	}
	,logStats: function(uid,embed) {
		...
		Main.client.channels.fetch(this.logChannelId).then(function(channel) {
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 570, className : "commands.ScamPrevention", methodName : "logStats"});
			$global.console.dir(err);
		});
	}
	,logMessage: function(uid,embed,action) {
		...
		Main.client.channels.fetch(this.logChannelId).then(function(channel) {
			...
			haxe_Log.trace(err,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 581, className : "commands.ScamPrevention", methodName : "logMessage"});
			$global.console.dir(err);
		});
	}
	...
	,hasKeyword: function(message) {
		...
		while(_g < _g1.length) {
			...
			if(message.toLowerCase().indexOf(keyword) != -1) {
				haxe_Log.trace(keyword,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 600, className : "commands.ScamPrevention", methodName : "hasKeyword"});
				return true;
			}
		}
		return false;
				...
				if(message.content.indexOf(link) != -1) {
					...
					if(regex.match(message.content)) {
						...
						if(url.hostname.length == 0 || url.hostname == null) {
							haxe_Log.trace(regex.matched(1),{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 627, className : "commands.ScamPrevention", methodName : "checkPhishingLinks"});
							return false;
						}
	...
	,checkTags: function(messages) {
		...
		while(_g < messages.length) {
			...
			if(message.content.indexOf("@everyone") != -1 || message.content.indexOf("@here") != -1) {
				if(tag_count >= 3) {
					haxe_Log.trace("here",{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 649, className : "commands.ScamPrevention", methodName : "checkTags"});
					break;
				}
				++tag_count;
			}
	...
	,checkEquality: function(messages) {
		...
		while(_g < messages.length) {
			...
			try {
				...
				haxe_Log.trace(_g2,{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 678, className : "commands.ScamPrevention", methodName : "checkEquality"});
				haxe_Log.trace(JSON.stringify(messages),{ fileName : "src/commands/ScamPrevention.hx", lineNumber : 679, className : "commands.ScamPrevention", methodName : "checkEquality"});
			}
		}
...
commands_ThreadCount.prototype = $extend(systems_CommandBase.prototype,{
		...
		var e = database_DBEvents.GetAllRecords("threadcount",function(resp) {
			if(resp._hx_index == 2) {
				...
				while(item.hasNext()) {
					...
					if(item1.hasField("_insertedId")) {
						item1.removeField("_insertedId");
						haxe_Log.trace("removed a field",{ fileName : "src/commands/ThreadCount.hx", lineNumber : 34, className : "commands.ThreadCount", methodName : "loadCounts"});
					}
					var r = database_types_DBThreadCount.fromRecord(item1);
					_gthis.count.h[r.threadid] = r;
				}
				haxe_Log.trace("Loaded thread counts",{ fileName : "src/commands/ThreadCount.hx", lineNumber : 39, className : "commands.ThreadCount", methodName : "loadCounts"});
			} else {
				haxe_Log.trace(resp,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 41, className : "commands.ThreadCount", methodName : "loadCounts"});
			}
		});
		var _ecsTmpEntity = this.universe.createEntity();
		this.universe.components.set(_ecsTmpEntity,5,e);
				...
				if(Object.prototype.hasOwnProperty.call(this.count.h,channel.id)) {
					...
					try {
						...
						var e = database_DBEvents.Update("threadcount",db,QueryExpr.QueryBinop(QBinop.QOpEq,QueryExpr.QueryConstant(QConstant.QIdent("threadid")),QueryExpr.QueryValue(channel.id)),function(resp) {
							if(resp._hx_index != 4) {
								haxe_Log.trace(resp,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 65, className : "commands.ThreadCount", methodName : "update"});
							}
						});
						var entity1 = util_EcsTools.get_universe().createEntity();
						util_EcsTools.get_universe().components.set(entity1,5,e);
						...
						var _g1 = haxe_Exception.caught(_g);
						haxe_Log.trace(_g1,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 70, className : "commands.ThreadCount", methodName : "update"});
						haxe_Log.trace(db,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 71, className : "commands.ThreadCount", methodName : "update"});
						haxe_Log.trace(db.threadid,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 72, className : "commands.ThreadCount", methodName : "update"});
						haxe_Log.trace(db.count,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 73, className : "commands.ThreadCount", methodName : "update"});
					}
				} else {
					...
					var e1 = database_DBEvents.Insert("threadcount",db,function(resp) {
						if(resp._hx_index != 4) {
							haxe_Log.trace(resp,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 80, className : "commands.ThreadCount", methodName : "update"});
						}
					});
					var entity2 = util_EcsTools.get_universe().createEntity();
					util_EcsTools.get_universe().components.set(entity2,5,e1);
	...
	,loadToDB: function() {
		...
		haxe_Log.trace(this.arr.length,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 105, className : "commands.ThreadCount", methodName : "loadToDB"});
		var timer = new haxe_Timer(200);
		timer.run = function() {
			haxe_Log.trace(_gthis.i,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 108, className : "commands.ThreadCount", methodName : "loadToDB"});
			...
			Main.client.channels.fetch(data.thread).then(function(ch) {
				...
				var e = database_DBEvents.Insert("threadcount",r,function(resp) {
					haxe_Log.trace(resp,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 124, className : "commands.ThreadCount", methodName : "loadToDB"});
				});
				var entity = util_EcsTools.get_universe().createEntity();
				util_EcsTools.get_universe().components.set(entity,5,e);
				var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
				...
				haxe_Log.trace(err,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 128, className : "commands.ThreadCount", methodName : "loadToDB"});
			});
			_gthis.i++;
		};
	}
	,run: function(command,interaction) {
		if(Object.prototype.hasOwnProperty.call(this.count.h,interaction.channelId)) {
			...
			interaction.reply({ content : "This thread has " + data.count + " messages"}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 137, className : "commands.ThreadCount", methodName : "run"});
				$global.console.dir(err);
			});
		} else {
			var content = "";
			...
			interaction.reply({ content : content}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/ThreadCount.hx", lineNumber : 149, className : "commands.ThreadCount", methodName : "run"});
				$global.console.dir(err);
			});
		}
	}
...
var database_types_DBMessageCounter = function() {
	database_MyRecord.call(this);
};
$hxClasses["database.types.DBMessageCounter"] = database_types_DBMessageCounter;
database_types_DBMessageCounter.__name__ = "database.types.DBMessageCounter";
...
database_types_DBMessageCounter.prototype = $extend(database_MyRecord.prototype,{
	...
	,get_record: function() {
		...
		this._record.field("userId",this.userId);
		if(this._record == null) {
			this._record = new db_Record();
		}
...
haxe_NativeStackTrace.saveStack = function(exception) {
	haxe_NativeStackTrace.lastError = exception;
};
...
haxe_NativeStackTrace.toHaxe = function(nativeStackTrace,skip) {
	if(skip == null) {
		skip = 0;
	}
	if(nativeStackTrace == null) {
		return [];
	} else if(typeof(nativeStackTrace) == "string") {
		var stack = nativeStackTrace.split("\n");
		if(stack[0] == "Error") {
			stack.shift();
		}
		var m = [];
		...
		return m;
	} else if(skip > 0 && Array.isArray(nativeStackTrace)) {
...
haxe_http_HttpNodeJs.prototype = $extend(haxe_http_HttpBase.prototype,{
	...
	,request: function(post) {
		...
		while(_g < _g1.length) {
			...
			if(this.encodeUrl) {
				var s = p.name;
				k = encodeURIComponent(s);
				var s1 = p.value;
				v = encodeURIComponent(s1);
			}
			uri += k + "=" + v;
		}
...
haxe_io_Input.prototype = {
	...
	,readBytes: function(s,pos,len) {
		...
		try {
			...
			if(!((haxe_Exception.caught(_g)) instanceof haxe_io_Eof)) {
				throw _g;
			}
		}
		return len - k;
...
haxe_io_Output.prototype = {
	...
	,writeByte: function(c) {
		throw new haxe_exceptions_NotImplementedException(null,null,{ fileName : "haxe/io/Output.hx", lineNumber : 49, className : "haxe.io.Output", methodName : "writeByte"});
	}
...
haxe_macro_Printer.prototype = {
	...
	,printField: function(field) {
		...
		switch(_g._hx_index) {
		case 0:
			var acc = field.access != null && Lambda.has(field.access,haxe_macro_Access.AFinal) ? "" : "var ";
			tmp = acc + ("" + field.name) + this.opt(_g.t,$bind(this,this.printComplexType)," : ") + this.opt(_g.e,$bind(this,this.printExpr)," = ");
			break;
		case 1:
		...
		case 2:
			var acc = field.access != null && Lambda.has(field.access,haxe_macro_Access.AFinal) ? "" : "var ";
			tmp = acc + ("" + field.name + "(" + _g.get + ", " + _g.set + ")") + this.opt(_g.t,$bind(this,this.printComplexType)," : ") + this.opt(_g.e,$bind(this,this.printExpr)," = ");
			break;
		}
		return tmp1 + tmp;
	}
	...
	,printTypeDefinition: function(t,printPackage) {
		...
		if(t == null) {
			...
			case 5:
				...
				case 0:
					var acc = _gaccess != null && Lambda.has(_gaccess,haxe_macro_Access.AFinal) ? "" : "var ";
					str4 = acc + ("" + t.name) + this.opt(_gkind.t,$bind(this,this.printComplexType)," : ") + this.opt(_gkind.e,$bind(this,this.printExpr)," = ") + ";";
					break;
				case 1:
					var _gf = _gkind.f;
				...
				case 2:
					var acc = _gaccess != null && Lambda.has(_gaccess,haxe_macro_Access.AFinal) ? "" : "var ";
					str4 = acc + ("" + t.name + "(" + _gkind.get + ", " + _gkind.set + ")") + this.opt(_gkind.t,$bind(this,this.printComplexType)," : ") + this.opt(_gkind.e,$bind(this,this.printExpr)," = ") + ";";
					break;
				}
				str1 = str2 + str4;
				break;
...
queues_IQueue.prototype = {
	...
	,get_onMessage: null
	,set_onMessage: null
	,get_onMessageWithProperties: null
	,set_onMessageWithProperties: null
	,config: null
	,start: null
	,stop: null
	,enqueue: null
	...
	,__properties__: {set_onMessageWithProperties:"set_onMessageWithProperties",get_onMessageWithProperties:"get_onMessageWithProperties",set_onMessage:"set_onMessage",get_onMessage:"get_onMessage",set_name:"set_name",get_name:"get_name"}
};
...
var systems_DatabaseSystem = function(_universe) {
	...
	ecs_System.call(this,_universe);
	this.dbevents = this.universe.families.get(3);
	this.table2136a94390b838cdff652db2cbb1a2d7 = this.universe.components.getTable(5);
};
	...
	,update: function(_) {
		...
		while(_g_keys.hasNext()) {
			...
			if(diff > _g_value) {
				...
				var entity = util_EcsTools.get_universe().createEntity();
				util_EcsTools.get_universe().components.set(entity,5,key);
				var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
				var ecsTmpFamily = util_EcsTools.get_universe().families.get(3);
				if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
					ecsTmpFamily.add(entity);
...
systems_MessageRouter.prototype = $extend(ecs_System.prototype,{
	...
	,update: function(_) {
		...
		while(_active && _g_idx >= 0) {
			...
			var channel = message.channel;
			var entity1 = util_EcsTools.get_universe().createEntity();
			util_EcsTools.get_universe().components.set(entity1,2,"rate_limit");
			util_EcsTools.get_universe().components.set(entity1,3,message);
			var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity1)];
			...
			var ecsTmpFamily3 = util_EcsTools.get_universe().families.get(2);
			if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily3.componentsMask)) {
				ecsTmpFamily3.add(entity1);
			}
			var entity2 = util_EcsTools.get_universe().createEntity();
			util_EcsTools.get_universe().components.set(entity2,2,"message_counter");
			util_EcsTools.get_universe().components.set(entity2,3,message);
			var ecsEntCompFlags1 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity2)];
			var ecsTmpFamily4 = util_EcsTools.get_universe().families.get(1);
			...
			var ecsTmpFamily7 = util_EcsTools.get_universe().families.get(2);
			...
			util_EcsTools.get_universe().components.set(entity3,2,"scam_prevention");
			util_EcsTools.get_universe().components.set(entity3,3,message);
			var ecsEntCompFlags2 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity3)];
			var ecsTmpFamily8 = util_EcsTools.get_universe().families.get(1);
			...
			var ecsTmpFamily11 = util_EcsTools.get_universe().families.get(2);
			...
			util_EcsTools.get_universe().components.set(entity4,2,"keyword_tracker");
			util_EcsTools.get_universe().components.set(entity4,3,message);
			var ecsEntCompFlags3 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity4)];
			var ecsTmpFamily12 = util_EcsTools.get_universe().families.get(1);
			...
			var ecsTmpFamily15 = util_EcsTools.get_universe().families.get(2);
			...
			if(channel.id == this.voicechat) {
				...
				util_EcsTools.get_universe().components.set(entity5,2,"voice_chat_bridge");
				util_EcsTools.get_universe().components.set(entity5,3,message);
				var ecsEntCompFlags4 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity5)];
				var ecsTmpFamily16 = util_EcsTools.get_universe().families.get(1);
				...
				var ecsTmpFamily19 = util_EcsTools.get_universe().families.get(2);
			...
			if(channel.id == this.voice) {
				...
				util_EcsTools.get_universe().components.set(entity6,2,"voice_channel_bridge");
				util_EcsTools.get_universe().components.set(entity6,3,message);
				var ecsEntCompFlags5 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity6)];
				var ecsTmpFamily20 = util_EcsTools.get_universe().families.get(1);
				...
				var ecsTmpFamily23 = util_EcsTools.get_universe().families.get(2);
			...
			if(channel.id == "1234544675264925788") {
				...
				util_EcsTools.get_universe().components.set(entity7,2,"suggestion_box");
				util_EcsTools.get_universe().components.set(entity7,3,message);
				var ecsEntCompFlags6 = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity7)];
				var ecsTmpFamily24 = util_EcsTools.get_universe().families.get(1);
				if(bits_Bits.areSet(ecsEntCompFlags6,ecsTmpFamily24.componentsMask)) {
					ecsTmpFamily24.add(entity7);
				}
				var ecsTmpFamily25 = util_EcsTools.get_universe().families.get(4);
				if(bits_Bits.areSet(ecsEntCompFlags6,ecsTmpFamily25.componentsMask)) {
					ecsTmpFamily25.add(entity7);
				}
				var ecsTmpFamily26 = util_EcsTools.get_universe().families.get(5);
				if(bits_Bits.areSet(ecsEntCompFlags6,ecsTmpFamily26.componentsMask)) {
					ecsTmpFamily26.add(entity7);
				}
				var ecsTmpFamily27 = util_EcsTools.get_universe().families.get(2);
				if(bits_Bits.areSet(ecsEntCompFlags6,ecsTmpFamily27.componentsMask)) {
					ecsTmpFamily27.add(entity7);
				}
			}
			switch(channel.type) {
			case 0:
	...
	,publicThreadChannel: function(message) {
		if(StringTools.startsWith(message.content,"[showcase]")) {
			var entity = util_EcsTools.get_universe().createEntity();
			util_EcsTools.get_universe().components.set(entity,2,"showcase");
			util_EcsTools.get_universe().components.set(entity,3,message);
			var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
			var ecsTmpFamily = util_EcsTools.get_universe().families.get(1);
			if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
				ecsTmpFamily.add(entity);
			...
			var ecsTmpFamily = util_EcsTools.get_universe().families.get(2);
			if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
				ecsTmpFamily.add(entity);
			}
		}
		var entity = util_EcsTools.get_universe().createEntity();
		util_EcsTools.get_universe().components.set(entity,2,"thread_count");
		util_EcsTools.get_universe().components.set(entity,3,message);
		var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
		var ecsTmpFamily = util_EcsTools.get_universe().families.get(1);
		if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
	...
	,guildTextChannel: function(message) {
		...
		if(channel.id == "162664383082790912" && !message.system) {
			var entity = util_EcsTools.get_universe().createEntity();
			util_EcsTools.get_universe().components.set(entity,2,"showcase_message");
			util_EcsTools.get_universe().components.set(entity,3,message);
			var ecsEntCompFlags = util_EcsTools.get_universe().components.flags[ecs_Entity.id(entity)];
			var ecsTmpFamily = util_EcsTools.get_universe().families.get(1);
			if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
		...
		if(StringTools.startsWith(message.content,"!run")) {
			haxe_Log.trace("here",{ fileName : "src/systems/MessageRouter.hx", lineNumber : 67, className : "systems.MessageRouter", methodName : "guildTextChannel"});
			var _ecsTmpEntity = this.universe.createEntity();
			this.universe.components.set(_ecsTmpEntity,4,"!run");
			this.universe.components.set(_ecsTmpEntity,3,message);
			var ecsEntCompFlags = this.universe.components.flags[ecs_Entity.id(_ecsTmpEntity)];
			var ecsTmpFamily = this.universe.families.get(2);
			if(bits_Bits.areSet(ecsEntCompFlags,ecsTmpFamily.componentsMask)) {
				ecsTmpFamily.add(_ecsTmpEntity);
			}
