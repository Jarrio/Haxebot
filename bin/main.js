...
Main.start = function() {
	...
	Main.universe.systems.add(new systems_commands_Index(Main.universe));
	...
	Main.client.on("ChatInputAutoCompleteEvent",function(incoming) {
		haxe_Log.trace("disconnected",{ fileName : "src/Main.hx", lineNumber : 86, className : "Main", methodName : "start"});
		haxe_Log.trace(incoming,{ fileName : "src/Main.hx", lineNumber : 87, className : "Main", methodName : "start"});
	});
...
Main.main = function() {
	...
	Main.app = firebase_app_FirebaseApp.initializeApp(Main.config.firebase);
...
var components_CommandOptions = $hxEnums["components.CommandOptions"] = { __ename__:"components.CommandOptions",__constructs__:null
	...
	,Index: ($_=function(topic,source_url,title,description) { return {_hx_index:2,topic:topic,source_url:source_url,title:title,description:description,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Index",$_.__params__ = ["topic","source_url","title","description"],$_)
	,Roundup: ($_=function(number) { return {_hx_index:3,number:number,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Roundup",$_.__params__ = ["number"],$_)
	,Rtfm: ($_=function(channel) { return {_hx_index:4,channel:channel,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Rtfm",$_.__params__ = ["channel"],$_)
	,Api: ($_=function(channel) { return {_hx_index:5,channel:channel,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Api",$_.__params__ = ["channel"],$_)
	,Notify: ($_=function(channel) { return {_hx_index:6,channel:channel,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Notify",$_.__params__ = ["channel"],$_)
	,Code: ($_=function(code) { return {_hx_index:7,code:code,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Code",$_.__params__ = ["code"],$_)
	,Help: ($_=function(category) { return {_hx_index:8,category:category,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Help",$_.__params__ = ["category"],$_)
	,Haxelib: ($_=function(command) { return {_hx_index:9,command:command,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Haxelib",$_.__params__ = ["command"],$_)
};
components_CommandOptions.__constructs__ = [components_CommandOptions.Hi,components_CommandOptions.Helppls,components_CommandOptions.Index,components_CommandOptions.Roundup,components_CommandOptions.Rtfm,components_CommandOptions.Api,components_CommandOptions.Notify,components_CommandOptions.Code,components_CommandOptions.Help,components_CommandOptions.Haxelib];
...
var firebase_app_FirebaseApp = require("firebase/app");
var firebase_firestore_Query = require("firebase/firestore");
var firebase_firestore_Firestore = require("firebase/firestore");
var firebase_firestore_QueryConstraint = require("firebase/firestore");
var firebase_firestore_Unsubscribe = require("firebase/firestore");
...
var promhx_base_AsyncBase = function(d,pos) {
	...
	promhx_base_AsyncBase.id_ctr += 1;
	this.id = promhx_base_AsyncBase.id_ctr;
...
promhx_base_AsyncBase.immediateLinkUpdate = function(current,next,f) {
	...
	if(current._resolved && !current._pending) {
		try {
			...
			next.handleError(haxe_Exception.caught(_g).unwrap());
		}
	}
};
	...
	,_handleError: function(error) {
		...
		var update_errors = function(e) {
			if(_gthis._error.length > 0) {
				...
				var result = new Array(stacks.length);
				var _g = 0;
				var _g1 = stacks.length;
				while(_g < _g1) {
					var i = _g++;
					var s = stacks[i];
					result[i] = "" + s.fileName + ":" + s.lineNumber + " " + s.className + "." + s.methodName + "()";
				}
				var stackString = "Promise Call Stack:\n\t" + result.join("\n\t");
				haxe_Log.trace(stackString,{ fileName : "promhx/base/AsyncBase.hx", lineNumber : 188, className : "promhx.base.AsyncBase", methodName : "_handleError"});
...
var promhx_Deferred = $hx_exports["promhx"]["Deferred"] = function() {
	promhx_base_AsyncBase.call(this,null,{ fileName : "promhx/Deferred.hx", lineNumber : 7, className : "promhx.Deferred", methodName : "new"});
};
...
promhx_Deferred.prototype = $extend(promhx_base_AsyncBase.prototype,{
	...
	,promise: function() {
		return new promhx_Promise(this,{ fileName : "promhx/Deferred.hx", lineNumber : 20, className : "promhx.Deferred", methodName : "promise"});
	}
	,stream: function() {
		return new promhx_Stream(this,{ fileName : "promhx/Deferred.hx", lineNumber : 27, className : "promhx.Deferred", methodName : "stream"});
	}
	,publicStream: function() {
		return new promhx_PublicStream(this,{ fileName : "promhx/Deferred.hx", lineNumber : 34, className : "promhx.Deferred", methodName : "publicStream"});
	}
...
promhx_Promise.prototype = $extend(promhx_base_AsyncBase.prototype,{
	...
	,handleResolve: function(val) {
		if(this._resolved) {
			throw haxe_Exception.thrown(promhx_error_PromiseError.AlreadyResolved("Promise has already been resolved"));
		}
		this._resolve(val);
	}
	,then: function(f,pos) {
	...
	,pipe: function(f,pos) {
		...
		if(this._resolved && !this._pending) {
			try {
				...
				var _g1 = haxe_Exception.caught(_g).unwrap();
				ret1.handleError(_g1);
			}
		}
		return ret;
	}
	,errorPipe: function(f) {
		var ret = new promhx_Promise(null,{ fileName : "promhx/Promise.hx", lineNumber : 137, className : "promhx.Promise", methodName : "errorPipe"});
		this.catchError(function(e) {
			var piped = f(e);
			piped.then($bind(ret,ret._resolve),{ fileName : "promhx/Promise.hx", lineNumber : 140, className : "promhx.Promise", methodName : "errorPipe"});
		});
		this.then($bind(ret,ret._resolve),{ fileName : "promhx/Promise.hx", lineNumber : 142, className : "promhx.Promise", methodName : "errorPipe"});
		return ret;
	}
...
var promhx_Stream = $hx_exports["promhx"]["Stream"] = function(d,pos) {
	promhx_base_AsyncBase.call(this,d,pos);
	this._end_promise = new promhx_Promise(null,{ fileName : "promhx/Stream.hx", lineNumber : 21, className : "promhx.Stream", methodName : "new"});
};
...
promhx_Stream.concatAll = function(itb,pos) {
	...
	while(i.hasNext()) {
		var i1 = i.next();
		ret.concat(i1,{ fileName : "promhx/Stream.hx", lineNumber : 124, className : "promhx.Stream", methodName : "concatAll"});
	}
	return ret;
};
promhx_Stream.mergeAll = function(itb,pos) {
	...
	while(i.hasNext()) {
		var i1 = i.next();
		ret.merge(i1,{ fileName : "promhx/Stream.hx", lineNumber : 134, className : "promhx.Stream", methodName : "mergeAll"});
	}
	return ret;
};
...
promhx_Stream.prototype = $extend(promhx_base_AsyncBase.prototype,{
	...
	,detachStream: function(str) {
		...
		while(_g < _g1.length) {
			...
			++_g;
			if(u.async == str) {
				var _this = this._end_promise._update;
				var _g2 = [];
				var _g3 = 0;
	...
	,first: function(pos) {
		...
		},{ fileName : "promhx/Stream.hx", lineNumber : 143, className : "promhx.Stream", methodName : "first"});
		return s;
	}
	,handleResolve: function(val) {
	...
	,pipe: function(f,pos) {
		...
		this._end_promise.then(function(x) {
			ret.end();
		},{ fileName : "promhx/Stream.hx", lineNumber : 163, className : "promhx.Stream", methodName : "pipe"});
		return ret;
	}
	,errorPipe: function(f,pos) {
		...
		this.catchError(function(e) {
			var piped = f(e);
			piped.then($bind(ret,ret._resolve),{ fileName : "promhx/Stream.hx", lineNumber : 174, className : "promhx.Stream", methodName : "errorPipe"});
			piped._end_promise.then(($_=ret._end_promise,$bind($_,$_._resolve)),{ fileName : "promhx/Stream.hx", lineNumber : 175, className : "promhx.Stream", methodName : "errorPipe"});
		});
		this.then($bind(ret,ret._resolve),{ fileName : "promhx/Stream.hx", lineNumber : 177, className : "promhx.Stream", methodName : "errorPipe"});
		this._end_promise.then(function(x) {
			ret.end();
		},{ fileName : "promhx/Stream.hx", lineNumber : 178, className : "promhx.Stream", methodName : "errorPipe"});
		return ret;
	}
	,handleEnd: function() {
		if(this._pending) {
	...
	,endThen: function(f) {
		return this._end_promise.then(f,{ fileName : "promhx/Stream.hx", lineNumber : 204, className : "promhx.Stream", methodName : "endThen"});
	}
	...
	,concat: function(s,pos) {
		...
		this._end_promise.then(function(_) {
			s.pipe(function(x) {
				ret.handleResolve(x);
				return ret;
			},{ fileName : "promhx/Stream.hx", lineNumber : 234, className : "promhx.Stream", methodName : "concat"});
			s._end_promise.then(function(_) {
				ret.end();
			},{ fileName : "promhx/Stream.hx", lineNumber : 204, className : "promhx.Stream", methodName : "endThen"});
		},{ fileName : "promhx/Stream.hx", lineNumber : 204, className : "promhx.Stream", methodName : "endThen"});
		return ret;
	}
...
systems_commands_Helppls.prototype = $extend(systems_CommandBase.prototype,{
	...
	,onAdded: function() {
		...
		firebase_firestore_Firestore.updateDoc(firebase_firestore_Firestore.doc(db,"test","mcXuD85vFTBOG0vAZi3I"),{ name : "test doc"}).then(function(_) {
			haxe_Log.trace("added",{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 28, className : "systems.commands.Helppls", methodName : "onAdded"});
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 28, className : "systems.commands.Helppls", methodName : "onAdded"});
		});
		firebase_firestore_Firestore.getDocs(q).then(function(docs) {
			docs.forEach(function(doc) {
				haxe_Log.trace(doc.data().name,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 32, className : "systems.commands.Helppls", methodName : "onAdded"});
			});
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 34, className : "systems.commands.Helppls", methodName : "onAdded"});
		});
	}
	,update: function(_) {
		...
		while(_g.active && _g.idx < _g.set.size()) {
			...
			var author = message[0].author.id;
			var state = this.state.h[author];
			if(state != 0) {
				var reply = message[0].content;
				if(state != null) {
					switch(state) {
					case 1:
			...
			if(state == null) {
				haxe_Log.trace("something else " + state,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 128, className : "systems.commands.Helppls", methodName : "update"});
			} else {
				switch(state) {
				case 0:
					var question = this.questionChannel(message[0].author.id);
					var message1 = message[0].author;
					var embed = new discord_$js_MessageEmbed();
					embed.setDescription(question);
					message1.send({ embeds : [embed]});
					break;
				case 1:
					this.updateSessionChannel(author,state,this.getChannel(message[0].content));
					this.questionIsThereAnError(message[0]);
					break;
				case 2:
					if(message[0].content == "1") {
						this.questionWhatError(message[0]);
					} else {
						this.questionPasteSomeCode(message[0]);
					}
					break;
				case 3:
					this.questionPasteSomeCode(message[0]);
					break;
				case 4:
					this.questionExpectedBehaviour(message[0]);
					break;
				case 5:
					haxe_Log.trace("finished?",{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 80, className : "systems.commands.Helppls", methodName : "update"});
					...
					while(_g1.hasNext()) {
						...
						case 2:
							continue;
						case 4:
							var json = this.parseErrorMessage(this.session.h[message[0].author.id].h[3].answer);
							if(json != null) {
								...
								while(_g2_current < split.length) {
									...
									code += "" + (_g3_key + from) + "   " + StringTools.trim(_g3_value) + " \n";
								}
								answer = "```hx\n" + code + "\n```";
							}
							break;
						...
						embed1[0].addField(value.question,answer);
					}
					message[0].client.channels.fetch(this.getChannelId("other")).then((function(embed,message) {
						return function(channel) {
							channel.send({ embeds : [embed[0]]}).then((function(message) {
								return function(channel_message) {
									channel_message.startThread({ name : "topic"}).then((function(message) {
										return function(thread) {
											message[0].author.send({ content : "Your thread(__<#" + thread.id + ">__) has been created!"});
					...
					})(embed1,message),(function() {
						return function(err) {
							haxe_Log.trace(err,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 119, className : "systems.commands.Helppls", methodName : "update"});
						};
					})());
					break;
				case 6:
					this.questionWhatsHappening(message[0]);
					break;
				default:
					haxe_Log.trace("something else " + state,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 128, className : "systems.commands.Helppls", methodName : "update"});
				}
	...
	,questionIsThereAnError: function(message) {
		...
		this.updateSessionQuestion(message.author.id,2,"Is there an Error Message?");
	...
	,questionExpectedBehaviour: function(message) {
		...
		this.updateSessionQuestion(message.author.id,6,"What do you expect to happen?");
		var message1 = message.author;
		var embed = new discord_$js_MessageEmbed();
...
var systems_commands_Index = function(universe) {
	...
	var query = firebase_firestore_Firestore.query(firebase_firestore_Firestore.collection(firebase_firestore_Firestore.getFirestore(firebase_app_FirebaseApp.getApp()),"index"));
	firebase_firestore_Firestore.onSnapshot(query,function(snapshot) {
		snapshot.forEach(function(result) {
			haxe_Log.trace(result.data(),{ fileName : "src/systems/commands/Index.hx", lineNumber : 32, className : "systems.commands.Index", methodName : "new"});
		});
	},function(error) {
		haxe_Log.trace(error,{ fileName : "src/systems/commands/Index.hx", lineNumber : 36, className : "systems.commands.Index", methodName : "new"});
	});
};
...
systems_commands_Index.prototype = $extend(systems_CommandDbBase.prototype,{
	run: function(command,interaction) {
		...
		if(_g._hx_index == 2) {
			...
			haxe_Log.trace("topic: " + _g1,{ fileName : "src/systems/commands/Index.hx", lineNumber : 42, className : "systems.commands.Index", methodName : "run"});
			haxe_Log.trace("source_url: " + _g2,{ fileName : "src/systems/commands/Index.hx", lineNumber : 43, className : "systems.commands.Index", methodName : "run"});
			haxe_Log.trace("title: " + _g3,{ fileName : "src/systems/commands/Index.hx", lineNumber : 44, className : "systems.commands.Index", methodName : "run"});
			haxe_Log.trace("description: " + _g4,{ fileName : "src/systems/commands/Index.hx", lineNumber : 45, className : "systems.commands.Index", methodName : "run"});
			firebase_firestore_Firestore.addDoc(firebase_firestore_Firestore.collection(firebase_firestore_Firestore.getFirestore(firebase_app_FirebaseApp.getApp()),"index"),{ topic : _g1, source_url : _g2, title : _g3, description : _g4, created_at : new Date(), added_by : interaction.user.id, validated : false, validated_by : ""}).then(function(_) {
				haxe_Log.trace("added",{ fileName : "src/systems/commands/Index.hx", lineNumber : 55, className : "systems.commands.Index", methodName : "run"});
			},function(err) {
				haxe_Log.trace(err,{ fileName : "src/systems/commands/Index.hx", lineNumber : 55, className : "systems.commands.Index", methodName : "run"});
			});
		}
	}
	,getChannelId: function(channel) {
	...
	,table6c16270644d94dba4055a067a073b12c: null
	,table87a8f92f715c03d0822a55d9b93a210d: null
	,__class__: systems_commands_Index
});
