...
systems_commands_Helppls.prototype = $extend(systems_CommandBase.prototype,{
	...
	,update: function(_) {
		...
		while(_g.active && _g.idx < _g.set.size()) {
			...
			if(state == null) {
				haxe_Log.trace("something else " + state,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 114, className : "systems.commands.Helppls", methodName : "update"});
			} else {
				switch(state) {
				case 0:
				...
				case 4:
					...
					break;
				case 5:
					haxe_Log.trace("finished?",{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 65, className : "systems.commands.Helppls", methodName : "update"});
					...
					message[0].client.channels.fetch(this.getChannelId("other")).then((function(embed,message) {
						...
						return function(err) {
							haxe_Log.trace(err,{ fileName : "src/systems/commands/Helppls.hx", lineNumber : 104, className : "systems.commands.Helppls", methodName : "update"});
						};
					})());
					break;
				case 6:
