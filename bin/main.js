...
Main.start = function() {
	...
	Main.client.once("ready",function() {
		...
		haxe_Log.trace("Ready!",{ fileName : "src/Main.hx", lineNumber : 146, className : "Main", methodName : "start"});
		...
		res.then(function(foo) {
			...
			while(_g < foo.length) {
				var item = foo[_g];
				++_g;
				haxe_Log.trace("DEBUG - " + item.name + " is REGISTERED",{ fileName : "src/Main.hx", lineNumber : 155, className : "Main", methodName : "start"});
			}
		},function(err) {
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 162, className : "Main", methodName : "start"});
			$global.console.dir(err);
		});
	});
	Main.client.on("guildMemberAdd",function(member) {
		haxe_Log.trace("member " + member.user.tag,{ fileName : "src/Main.hx", lineNumber : 168, className : "Main", methodName : "start"});
	...
	Main.client.on("ChatInputAutoCompleteEvent",function(incoming) {
		haxe_Log.trace("disconnected",{ fileName : "src/Main.hx", lineNumber : 225, className : "Main", methodName : "start"});
		haxe_Log.trace(incoming,{ fileName : "src/Main.hx", lineNumber : 226, className : "Main", methodName : "start"});
	});
	...
	Main.client.on("interactionCreate",function(interaction) {
		...
		if(interaction.isModalSubmit()) {
			...
			case "quote_set":
				...
				break;
			default:
				haxe_Log.trace(interaction.customId + " - unhandled model",{ fileName : "src/Main.hx", lineNumber : 266, className : "Main", methodName : "start"});
			}
			return;
		}
	...
	,update: function(_) {
		...
		while(_g_active && _g_idx >= 0) {
			...
			member.roles.add(this.event_role_id).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/AutoRole.hx", lineNumber : 19, className : "commands.AutoRole", methodName : "update"});
				$global.console.dir(err);
			});
			member.roles.add(this.news_role_id).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/AutoRole.hx", lineNumber : 23, className : "commands.AutoRole", methodName : "update"});
				$global.console.dir(err);
			});
			this.universe.deleteEntity(entity);
		}
...
commands_Hi.prototype = $extend(systems_CommandBase.prototype,{
	run: function(command,interaction) {
		...
		interaction.reply({ content : message}).then(null,function(err) {
			haxe_Log.trace(err,{ fileName : "src/commands/Hi.hx", lineNumber : 23, className : "commands.Hi", methodName : "run"});
			$global.console.dir(err);
		});
	}
	,get_name: function() {
			...
			interaction.member.fetch(true).then(function(member) {
				...
				if(found) {
					interaction.member.roles.remove(role).then(function(success) {
						...
						haxe_Log.trace(err,{ fileName : "src/commands/Notify.hx", lineNumber : 56, className : "commands.Notify", methodName : "run"});
						$global.console.dir(err);
					});
				} else {
					interaction.member.roles.add(role).then(function(success) {
						...
						haxe_Log.trace(err,{ fileName : "src/commands/Notify.hx", lineNumber : 63, className : "commands.Notify", methodName : "run"});
						$global.console.dir(err);
					});
				}
			},function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/Notify.hx", lineNumber : 68, className : "commands.Notify", methodName : "run"});
				$global.console.dir(err);
			});
		}
	}
...
commands_Run.prototype = $extend(systems_TextCommandBase.prototype,{
	...
	,update: function(_) {
		...
		if(!(now - this.last_cleared < clear_frame)) {
			...
			try {
				...
				var _g1 = haxe_Exception.caught(_g);
				haxe_Log.trace(_g1,{ fileName : "src/commands/Run.hx", lineNumber : 57, className : "commands.Run", methodName : "cleanDirectory"});
			}
		}
	}
	...
	,deleteFile: function(filename) {
		try {
			...
			haxe_Log.trace(_g1,{ fileName : "src/commands/Run.hx", lineNumber : 119, className : "commands.Run", methodName : "deleteFile"});
		}
	}
	...
	,runCodeOnThread: function(code,message) {
		...
		try {
			...
			js_node_Fs.appendFile("" + this.get_base_path() + "/hx/" + filename + ".hx",code_content + ("//User:" + message.author.tag + " | time: " + Std.string(new Date())),function(error) {
				if(error != null) {
					haxe_Log.trace(error,{ fileName : "src/commands/Run.hx", lineNumber : 360, className : "commands.Run", methodName : "runCodeOnThread"});
				}
				...
				ls.once("close",function(data) {
					...
					if(!sys_FileSystem.exists(js_file)) {
						haxe_Log.trace("Code likely errored and didnt compile (" + filename + ".js)",{ fileName : "src/commands/Run.hx", lineNumber : 405, className : "commands.Run", methodName : "runCodeOnThread"});
						ls.kill("SIGTERM");
						return;
					}
					var obj = null;
					...
					try {
						...
						if(response.length > 0 && data == 0) {
							message.reply({ embeds : [embed]}).then(function(succ) {
								haxe_Log.trace("" + message.author.tag + " at " + format_date + " with file id: " + filename,{ fileName : "src/commands/Run.hx", lineNumber : 487, className : "commands.Run", methodName : "runCodeOnThread"});
								return message.delete().then(null,function(err) {
									haxe_Log.trace(err,{ fileName : "src/commands/Run.hx", lineNumber : 491, className : "commands.Run", methodName : "runCodeOnThread"});
									$global.console.dir(err);
								});
							},function(err) {
								haxe_Log.trace(err,{ fileName : "src/commands/Run.hx", lineNumber : 495, className : "commands.Run", methodName : "runCodeOnThread"});
								$global.console.dir(err);
							});
							ls.kill();
							return;
						...
						message.reply({ content : mention + ("```\n" + compile_output + "```")});
						haxe_Log.trace(e,{ fileName : "src/commands/Run.hx", lineNumber : 505, className : "commands.Run", methodName : "runCodeOnThread"});
					}
				});
			});
			return;
			...
			haxe_Log.trace(e,{ fileName : "src/commands/Run.hx", lineNumber : 513, className : "commands.Run", methodName : "runCodeOnThread"});
...
commands_Snippet.prototype = $extend(systems_CommandDbBase.prototype,{
			...
			if(cache != null) {
				...
				case "snippet_left":
					...
					interaction.deferUpdate().then(null,function(err) {
						haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 59, className : "commands.Snippet", methodName : "update"});
						$global.console.dir(err);
					});
					this.universe.deleteEntity(entity);
					break;
				case "snippet_right":
					...
					cache.interacted_at = new Date().getTime();
					interaction.deferUpdate().then(null,function(err) {
						haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 73, className : "commands.Snippet", methodName : "update"});
						$global.console.dir(err);
					});
					this.universe.deleteEntity(entity);
					break;
		...
		while(_g1_current < _g1_length) {
			...
			item[0].message.edit({ embeds : [embed], components : []}).then((function(key) {
				...
				return function(err) {
					...
					haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 98, className : "commands.Snippet", methodName : "update"});
					$global.console.dir(err);
				};
			})(item,key1));
		}
	...
	,run: function(command,interaction) {
		...
		case 2:
			...
			interaction.reply({ embeds : [embed]}).then(null,function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 376, className : "commands.Snippet", methodName : "run"});
				$global.console.dir(err);
			});
			break;
		case 3:
		...
		case 4:
			...
			firebase_web_firestore_Firestore.getDocs(q).then(function(resp) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 326, className : "commands.Snippet", methodName : "run"});
				$global.console.dir(err);
			});
			break;
		case 5:
			...
			firebase_web_firestore_Firestore.getDocs(q).then(function(resp) {
				...
				firebase_web_firestore_Firestore.deleteDoc(resp.docs[0].ref).then(function(_) {
					...
					haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 355, className : "commands.Snippet", methodName : "run"});
					$global.console.dir(err);
				});
			},function(err) {
		...
		case 6:
			...
			firebase_web_firestore_Firestore.getDocs(q).then(function(resp) {
				...
				haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 266, className : "commands.Snippet", methodName : "run"});
				$global.console.dir(err);
			});
			break;
		case 7:
			...
			firebase_web_firestore_Firestore.getDocs(q).then(function(resp) {
				...
				firebase_web_firestore_Firestore.runTransaction(firebase_web_firestore_Firestore.getFirestore(firebase_web_app_FirebaseApp.getApp()),function(transaction) {
					...
					firebase_web_firestore_Firestore.addDoc(firebase_web_firestore_Firestore.collection(firebase_web_firestore_Firestore.getFirestore(firebase_web_app_FirebaseApp.getApp()),"discord/snippets/entries"),obj).then(function(_) {
						...
						haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 198, className : "commands.Snippet", methodName : "run"});
						$global.console.dir(err);
					});
				},function(err) {
					haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 202, className : "commands.Snippet", methodName : "run"});
					$global.console.dir(err);
				});
			},function(err) {
				haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 206, className : "commands.Snippet", methodName : "run"});
				$global.console.dir(err);
			});
			break;
		default:
	...
	,handleSearchResponse: function(interaction,state) {
		...
		interaction.reply({ embeds : [embed], components : arr, fetchReply : true}).then(function(message) {
			...
			haxe_Log.trace(err,{ fileName : "src/commands/Snippet.hx", lineNumber : 420, className : "commands.Snippet", methodName : "handleSearchResponse"});
			$global.console.dir(err);
		});
	}
