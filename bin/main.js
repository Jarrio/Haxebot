...
Main.main = function() {
	Main.app = firebase_app_FirebaseApp.initializeApp({ apiKey : "AIzaSyBKGASqr3dgNygiv3WnHzQKYv_iYTwK4Kk", databaseURL : "https://console.firebase.google.com/u/0/project/haxe-forum/firestore/data/~2F", authDomain : "haxe-forum.firebaseapp.com", projectId : "haxe-forum", storageBucket : "haxe-forum.appspot.com", messagingSenderId : "72566195073", appId : "1:72566195073:web:8d39d1f8d29227d2a79e80", measurementId : "G-VB7FNBVMZF"});
	try {
...
var components_CommandOptions = $hxEnums["components.CommandOptions"] = { __ename__:"components.CommandOptions",__constructs__:null
	...
	,Boop: ($_=function(user) { return {_hx_index:1,user:user,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Boop",$_.__params__ = ["user"],$_)
	,Poll: ($_=function(question,time) { return {_hx_index:2,question:question,time:time,__enum__:"components.CommandOptions",toString:$estr}; },$_._hx_name="Poll",$_.__params__ = ["question","time"],$_)
	...
	,extractDoxData: function(info,interaction) {
		...
		http.onData = function(resp) {
			...
			while(_g_current < _this.length) {
				...
				var _g = 0;
				var _g1 = item.querySelectorAll(".field");
				while(_g < _g1.length) {
					var field = _g1[_g];
					++_g;
...
systems_commands_ScamPrevention.prototype = $extend(systems_CommandBase.prototype,{
	...
	,reformatMessage: function(message) {
		var embed = new discord_$js_MessageEmbed();
