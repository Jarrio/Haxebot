...
Main.start = function() {
	var vec = new Array(2);
	vec[0] = new ecs_Phase(false,"testing",new Array(7),new Array(7));
	vec[1] = new ecs_Phase(true,"main",new Array(26),new Array(26));
	var phases = vec;
	...
	Main.client.on("interactionCreate",function(interaction) {
		...
		if(interaction.isModalSubmit()) {
			...
			case "quote_set":
				...
				break;
			default:
				haxe_Log.trace(interaction.customId + " - unhandled model",{ fileName : "src/Main.hx", lineNumber : 269, className : "Main", methodName : "start"});
			}
			return;
		}
...
Main.saveCommand = function(command) {
	...
	haxe_Log.trace("registered " + command.name,{ fileName : "src/Main.hx", lineNumber : 420, className : "Main", methodName : "saveCommand"});
};
Main.main = function() {
	try {
		...
		haxe_Log.trace(e.get_message(),{ fileName : "src/Main.hx", lineNumber : 431, className : "Main", methodName : "main"});
	}
	...
	firebase_web_auth_Auth.signInWithEmailAndPassword(firebase_web_auth_Auth.getAuth(),Main.keys.username,Main.keys.password).then(function(res) {
		haxe_Log.trace("logged in",{ fileName : "src/Main.hx", lineNumber : 441, className : "Main", methodName : "main"});
		...
		firebase_web_firestore_Firestore.getDoc(doc).then(function(resp) {
			...
			haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 450, className : "Main", methodName : "main"});
			$global.console.dir(err);
		});
	},function(err) {
		haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 454, className : "Main", methodName : "main"});
		$global.console.dir(err);
	});
	Main.start();
};
Main.updateState = function() {
	...
	firebase_web_firestore_Firestore.updateDoc(doc,"state",Main.state).then(null,function(err) {
		haxe_Log.trace(err,{ fileName : "src/Main.hx", lineNumber : 465, className : "Main", methodName : "updateState"});
		$global.console.dir(err);
	});
};
