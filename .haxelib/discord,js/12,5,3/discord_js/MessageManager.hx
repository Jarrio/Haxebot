...
@:jsRequire("discord.js", "MessageManager") extern class MessageManager extends BaseManager<String, Message, MessageResolvable> {
	...
	@:overload(function(?message:EitherType<String, ChannelLogsQuery>, ?options:BaseFetchOptions):js.lib.Promise<Message> { })
	public function fetch(?message:EitherType<String, ChannelLogsQuery>, ?options:BaseFetchOptions):js.lib.Promise<Collection<String, Message>>;
