...
@:jsRequire("discord.js", "TextChannel") extern class TextChannel {
	...
	public function createOverwrite(userOrRole:ts.AnyOf5<String, User, GuildMember, Message, Role>, options:PermissionOverwriteOption, ?reason:String):js.lib.Promise<TextChannel>;
	public function edit(data:ChannelData, ?reason:String):js.lib.Promise<TextChannel>;
	...
	public function overwritePermissions(overwrites:ts.AnyOf2<haxe.ds.ReadOnlyArray<OverwriteResolvable>, Collection<String, OverwriteResolvable>>, ?reason:String):js.lib.Promise<TextChannel>;
	...
	public function setParent(channel:Null<ts.AnyOf2<String, CategoryChannel>>, ?options:{ @:optional var lockPermissions : Bool; @:optional var reason : String; }):js.lib.Promise<TextChannel>;
	public function setPosition(position:Float, ?options:{ @:optional var relative : Bool; @:optional var reason : String; }):js.lib.Promise<TextChannel>;
